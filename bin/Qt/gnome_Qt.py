...
# Form implementation generated from reading bin file 'gnome.bin'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.bg.setText("")
        self.bg.setPixmap(QtGui.QPixmap(resource_path("bin/img/gnome/empty.png")))
        ...
        self.okay.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resource_path("bin/img/gnome/okdok1.bmp")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
