...
# Form implementation generated from reading bin file 'main_window.bin'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("bin/img/noclass.png"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("bin/img/sett.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.binds.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("bin/img/binds.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("bin/img/class.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.close.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("bin/img/close.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_2.setPixmap(QtGui.QPixmap("bin/img/hider.png"))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("bin/img/start_wow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.reload.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("bin/img/reload.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        print(resource_path("bin\\img\\bug_report.bmp"))
        icon8.addPixmap(QtGui.QPixmap(resource_path("bin\\img\\bug_report.bmp")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
