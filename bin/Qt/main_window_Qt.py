...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(resource_path("bin/img/main/noclass.png")))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resource_path("bin/img/main/settings.bmp")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.binds.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(resource_path("bin/img/main/binds.bmp")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(resource_path("bin/img/main/class.bmp")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.start.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(resource_path("bin/img/main/start.bmp")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.close.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(resource_path("bin/img/main/close.bmp")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.close.setIcon(icon5)
        self.close.setIconSize(QtCore.QSize(200, 150))
        self.close.setObjectName("close")
        self.hider = QtWidgets.QLabel(Dialog)
        self.hider.setGeometry(QtCore.QRect(512, 492, 141, 31))
        self.hider.setText("")
        self.hider.setPixmap(QtGui.QPixmap(resource_path("bin/img/main/hider.png")))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(resource_path("bin/img/main/start_wow.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.reload.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(resource_path("bin/img/main/reload.bmp")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.bug_report.setStyleSheet(resource_path("background-color: transpanent;"))
        self.bug_report.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(resource_path("bin/img/main/bug_report.bmp")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
