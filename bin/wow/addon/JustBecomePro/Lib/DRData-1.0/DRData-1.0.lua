...
L["ALLOWCOMM_DESC"] = [=[Erlaube anderen JBP Benutzern dir Daten zu schicken: 
...
L["ALPHA"] = "Alpha"
L["ANCHOR_CURSOR_DUMMY"] = "JBP Positionsanzeige Anker Attrappe. "
...
L["elite"] = "Elite"
L["ENABLINGOPT"] = "JustBecomePro_Options ist deaktiviert. Aktiviere..."
...
L["IMPORT_FROMCOMM_DESC"] = "Wenn ein anderer Benutzer von JustBecomePro Ihnen Konfigurationsdaten schickt, können Sie diese von diesem Untermenü importieren."
...
L["LDB_TOOLTIP2"] = "|cff7fffffRechts-Klick|r um die JBP Hauptoptionen anzuzeigen."
L["LEFT"] = "links"
L["LOCKED"] = "gesperrt"
L["Magic"] = "Magie"
...
L["MOON"] = "Mond"
L["NEWVERSION"] = "Eine neue Version von JustBecomePro ist verfügbar: %s"
...
L["UIPANEL_SUBTEXT2"] = "Symbole funktionieren im gesperrten Zustand. Im entsperrten Zustand können Sie die Symbolgruppen bewegen, die Größe ändern und mit einem Rechtsklick einzelne Symbole für weitere Optionen anklicken. Du kannst auch '/justbecomepro' oder /jbp zum sperren / entsperren eingeben."
...
L["ALLOWCOMM_DESC"] = "Permitir a otros usuarios de JustBecomePro enviarle datos. "
...
L["CACHING"] = [=[JustBecomePro está almacenando y filtrando todos los hechizos del juego. Sólo es necesario hacer esto una vez por parche de WoW. Puede acelerar o ralentizar este proceso usando la barra deslizante inferior. 

No tiene que esperar a que se complete este proceso para usar JustBecomePro. Sólo la lista de sugerencias depende de la finalización del almacenamiento de los hechizos. ]=]
...
L["CODESNIPPETS_DESC"] = [=[Esta funcionalidad le permite escribir fragmentos de código Lua que serán ejecutados cuando JustBecomePro se esté inicializando. 

Es una funcionalidad avanzapara para aquellos que tienen experiencia con Lua (o para quienes han recibido un snippet por otro usuario de JustBecomePro)

Los usos posibles incluyen escribir funciones personalizadas para usar en condiciones Lua (asegúrese de definir estas en JBP.CNDT.Env).
...
L["CONFIGMODE"] = "JustBecomePro está en modo de configuración. Los iconos no funcionarán hasta que salga del modo de configuración. Escriba '/justbecomepro' o '/jbp' para activar o desactivar el modo de configuración. "
...
L["DT_DOC_Duration"] = "Devuelve la duración restante actualmente en el icono. Se recomienda que dé formato a esto con [JBPFormatDuration]"
...
L["DT_DOC_JBPFormatDuration"] = "Devuelve una cadena formateada por el formato de tiempo de JustBecomePro. Alternativa a [FormatDuration]."
...
L["elite"] = "Élite"
L["ENABLINGOPT"] = "JustBecomePro_Options está deshabilitado. Habilitando..."
L["Enraged"] = "Enfurecer"
L["EQUIPSETTOCHECK"] = "Conjunto de equipamiento a comprobar (|cFFFF5959DISTINGUE MAYÚSCULAS DE MINÚSCULAS|r)"
L["ERROR_ACTION_DENIED_IN_LOCKDOWN"] = "No puede hacer esto en combate si la opción %q no está activada (escriba '/jbp options')."
L["ERROR_ANCHORSELF"] = "%s estaba intentando anclarse a sí mismo, así que JustBecomePro restableció su anclaje al centro de la pantalla para prevenir un fallo catastrófico. "
L["ERROR_MISSINGFILE"] = [=[Se requiere un reinicio completo de WoW para usar JustBecomePro %s:

No se encontró %s.

Desea reiniciar WoW ahora?]=]
L["ERROR_MISSINGFILE_NOREQ"] = [=[Para usar correctamente JustBecomePro %s podría requerirse un reinicio completo de WoW:

No se encontró %s.

Desea reiniciar WoW ahora?]=]
L["ERROR_MISSINGFILE_REQFILE"] = "Un fichero requerido"
L["ERROR_NO_LOCKTOGGLE_IN_LOCKDOWN"] = "No se puede desbloquear JustBecomePro estando en combate si la opción %q no está activada (escriba '/jbp options')."
L["ERROR_NOTINITIALIZED_NO_ACTION"] = "JustBecomePro no puede ejecutar esa acción si el addon no pudo inicializarse!"
L["ERROR_NOTINITIALIZED_NO_LOAD"] = "TellmeWhen_Opciones no se puede cargar si JustBecomePro no se pudo inicializar!"
...
L["EXPORT_SPECIALDESC2"] = "Otros usuarios de JustBecomePro sólo pueden importar estos datos si tienen la versión %s"
L["EXPORT_TOCOMM"] = "A Jugador"
L["EXPORT_TOCOMM_DESC"] = [=[Escriba el nombre de un jugador en el cuadro de edición y elija esta opción para enviarle los datos. Debe ser alguien a quien pueda susurrar (misma facción, servidor, online), y debe tener JustBecomePro v4.0.0+
...
L["fPROFILE"] = "Perfil: %s"
L["FROMNEWERVERSION"] = "Está importando datos que fueron creados por una versión de JustBecomePro más reciente que la suya. Algunos ajustes podrían no funcionar hasta que se actualice a la última versión. "
...
Recuerde que los iconos sólo funcionan cuando JustBecomePro está en su estado bloqueado, así que que escriba '/jbp' cuando termine esta configuración. 

Mientras configura JustBecomePro, asegúrese de leer los tooltips para cada ajuste. Estos tooltips a menudo contienen información importante sobre cómo funciona el ajuste!]=]
...
L["IMPORT_FROMCOMM_DESC"] = "Si otro usuario de JustBecomePro le manda datos de configuración, podrá importarlos desde este submenú. "
L["IMPORT_FROMLOCAL"] = "Desde Perfil"
L["IMPORT_FROMSTRING"] = "Desde Cadena"
L["IMPORT_FROMSTRING_DESC"] = [=[Las cadenas le permiten transferir datos de configuración de JustBecomePro fuera del juego. 
...
L["IMPORTERROR_INVALIDTYPE"] = "Intentó importar datos de un tipo desconocido. Compruebe si tiene la última versión de JustBecomePro instalada. "
...
L["LDB_TOOLTIP2"] = "|cff7fffffClick-Derecho|r para mostrar las opciones principales de JBP"
L["LEFT"] = "Izquierda"
L["LOADERROR"] = "No se pudo cargar JustBecomePro_Options:"
L["LOADINGOPT"] = "Cargando JustBecomePro_Options."
L["LOCKED"] = "Bloqueado"
...
L["MESSAGERECIEVE"] = "%s te ha mandado datos de JustBecomePro! Puedes importar estos datos en JustBecomePro usando el botón %q, ubicado en la parte baja del editor de iconos. "
L["MESSAGERECIEVE_SHORT"] = "%s te ha mandado datos de JustBecomePro!"
...
L["NEWVERSION"] = "Hay una nueva versión de JustBecomePro disponible: %s"
...
L["SUG_TOOLTIPTITLE"] = [=[Mientras escribe, JustBecomePro revisará su caché y determinará los hechizos que más probablemente estaba buscando. 
...
L["TEXTLAYOUTS_NOEDIT_DESC"] = [=[Este diseño de texto es un diseño por defecto que viene estándar con JustBecomePro y no puede ser modificado. 
...
L["UIPANEL_COMBATCONFIG_DESC"] = [=[Active esto para permitir la configuración de JustBecomePro estando en combate. 
...
L["UIPANEL_GROUPTYPE_ICON_DESC"] = "Muestra los iconos en el grupo usando la visualización tradicional de iconos de JustBecomePro"
...
También puede escribir /justbecomepro o /jbp para bloquear/desbloquear]=]
...
L["UIPANEL_SUBTEXT2"] = "Iconos de trabajo una vez cerradas Cuando desbloqueado, puede mover o grupos icono de tamaño y haga clic derecho en los iconos individuales para más opciones de configuración También puede escribir '/justbecomepro' o '/jbp' para bloquear o desbloquear."
...
L["ALLOWCOMM_DESC"] = "Autoriser les autres utilisateurs JustBecomePro à vous envoyer des données. Vous devrez recharger votre interface utilisateur ou vous déconnecter avant de pouvoir recevoir des données."
...
L["UIPANEL_SUBTEXT2"] = "Les icônes fonctionnent lorsqu'elles sont verrouillées. Si déverrouillées, vous pouvez déplacer/redimensionner les groupes d'icônes et cliquer droit les icônes individuelles pour plus de réglages. Vous pouvez aussi taper '/justbecomepro' ou '/jbp' pour verrouiller/déverrouiller."
...
L["ALLOWCOMM_DESC"] = [=[다른 JustBecomePro 사용자들의 데이터 전송을 허용합니다.

UI를 다시 불러오거나 재접속 해야 데이터를 수신할 수 있습니다.]=]
L["ALLOWVERSIONWARN"] = "새로운 버전 알리기"
L["ALPHA"] = "불투명도"
L["ANCHOR_CURSOR_DUMMY"] = "JustBecomePro 커서 위치 기준 더미"
...
L["CACHING"] = [=[JustBecomePro은 게임 내 모든 주문을 저장하고 선별합니다. 와우 패치마다 한번만 완료하면 됩니다. 아래 슬라이더를 사용해 처리 속도를 올리거나 낮출 수 있습니다.

JustBecomePro을 사용하기 위해 이 과정이 완료될 때까지 기다릴 필요는 없습니다. 오직 추천 목록만 주문 캐시의 완성도에 영향을 받습니다.]=]
L["CACHINGSPEED"] = "프레임당 주문:"
L["CASTERFORM"] = "인간형"
L["CENTER"] = "중앙"
L["CHANGELOG"] = "변경 내역"
L["CHANGELOG_DESC"] = "JustBecomePro의 현재와 이전 버전에 만들어진 변경 내역을 표시합니다."
L["CHANGELOG_INFO2"] = [=[JustBecomePro v%s에 오신걸 환영합니다!
<br/><br/>
변경된 사항을 확인한 후에, %s 탭을 클릭하거나 하단의 %s 탭으로 JustBecomePro 설정을 시작하세요.]=]
...
L["CNDT_UNKNOWN_DESC"] = "당신의 설정에 식별자 %s|1을;를; 사용한 조건이 있지만, 그런 조건은 발견할 수 없었습니다. 아마도 구버전의 JBP를 사용 중이거나, 이 조건이 제거되었을 수 있습니다."
...
L["CODESNIPPET_AUTORUN_DESC"] = "활성화하면 이 코드 조각은 JBP_INITIALIZE가 발생하면 (PLAYER_LOGIN 중 발생하지만, 모든 아이콘과 그룹은 그 이전에 생성됩니다) 실행됩니다."
...
L["CODESNIPPETS_DESC"] = [=[이 기능은 JustBecomePro이 초기 구동될 때 실행될 Lua 코드의 덩어리를 작성할 수 있게 해줍니다.

Lua에 경험이 있는 사람들을 위한 고급 기능입니다 (또는 다른 JustBecomePro 사용자가 전달한 코드 조각의 사용자).

Lua 환경에서 사용할 사용자 설정 함수의 작성을 포함합니다.

코드 조각은 프로필 별로 또는 공용으로 정의될 수 있습니다 (공용 코드 조각은 모든 프로필에서 실행됩니다).

당신의 코드에 JustBecomePro 아이콘을 사용하려면, 아이콘을 |cff7fffffShift-클릭|r하세요.]=]
L["CODESNIPPETS_DESC_SHORT"] = "JustBecomePro이 초기 구동될 때 실행될 Lua 코드의 덩어리를 작성합니다."
...
다음에 작동하지 않습니다: |TInterface/AddOns/JustBecomePro/Textures/Alert:0:2|t
|cff7fffff-|r 파티원
...
L["CONDITIONS"] = "조건"
L["CONFIGMODE"] = "JustBecomePro이 설정 모드 상태입니다. 설정 모드를 빠져 나가기 까지 아이콘은 기능하지 않습니다. 설정 모드 켜기와 끄기를 전환하려면 '/justbecomepro'이나 '/jbp'를 입력하세요."
L["CONFIGMODE_EXIT"] = "설정 모드 나가기"
L["CONFIGMODE_EXITED"] = "JBP가 잠겼습니다. 다시 설정 모드로 들어가려면 /jbp를 입력하세요."
...
L["DBRESTORED_INFO"] = [=[JustBecomePro 데이터베이스가 비었거나 손상되었습니다.
여러가지 이유로 발생할 수 있으며, 일반적으로 WoW의 비정상적인 종료로 인해 발생합니다.

JustBecomePro_Options은 이런 식으로 JustBecomePro과 JustBecomePro_Options의 데이터베이스가 동시에 손상 될 가능성이 거의 없기 때문에 데이터베이스의 백업을 유지합니다.
...
L["DT_DOC_Counter"] = "JustBecomePro 카운터의 값을 반환합니다. 카운터는 아이콘 알림에서 생성되고 수정됩니다."
L["DT_DOC_Destination"] = "목적 대상 유닛이나 아이콘이 처리한 마지막 전투 이벤트의 이름을 반환합니다. [Name] 태그와 함께 사용하는 것이 가장 좋습니다. (이 태그는 %s 형식의 아이콘과 사용할 수 있습니다)"
L["DT_DOC_Duration"] = "아이콘에 현재 남은 지속시간으로 반환합니다. [JBPFormatDuration]으로 이 형식을 지정하는 것을 추천합니다."
...
L["DT_DOC_Timer"] = "JustBecomePro 타이머의 값을 반환합니다. 타이머는 아이콘 알림에서 생성되고 수정됩니다."
L["DT_DOC_JBPFormatDuration"] = "JustBecomePro의 시간 형식으로 형식화된 문자열을 반환합니다. [FormatDuration]과 비슷합니다."
...
L["elite"] = "정예"
L["ENABLINGOPT"] = "JustBecomePro_Options가 비활성 중입니다. 활성화 중..."
...
L["ERROR_ACTION_DENIED_IN_LOCKDOWN"] = "%q 옵션을 활성화하지 않았다면 전투 중에 할 수 없습니다 (이 옵션에 접근하려면 '/jbp options'를 입력하세요)."
L["ERROR_ANCHOR_CYCLICALDEPS"] = "%s|1을;를; %s에 고정하려고 시도했지만 %s의 위치는 %s의 위치에 영향을 받습니다, 따라서 JustBecomePro은 큰 변동을 방지하기 위해 고정 위치를 화면의 중앙으로 재설정 했습니다."
L["ERROR_ANCHORSELF"] = "%s|1이;가; 자기 자신에게 고정되려고 시도했습니다, 따라서 JustBecomePro은 큰 변동을 방지하기 위해 고정 위치를 화면의 중앙으로 재설정 했습니다."
L["ERROR_INVALID_SPELLID2"] = "아이콘이 올바르지 않은 주문ID를 확인하고 있습니다: %s. 원치 않는 아이콘의 동작을 피하려면 제거해 주세요."
L["ERROR_MISSINGFILE"] = [=[JustBecomePro %s|1을;를; 사용하려면 WoW의 완전한 재시작이 필요합니다.

%s|1을;를; 찾을 수 없습니다.

지금 WoW를 재시작하시겠습니까? ]=]
L["ERROR_MISSINGFILE_NOREQ"] = [=[JustBecomePro %s|1을;를; 완벽하게 사용하려면 WoW의 완전한 재시작이 필요할 수 있습니다.

%s|1을;를; 찾을 수 없습니다.

지금 WoW를 재시작하시겠습니까? ]=]
L["ERROR_MISSINGFILE_OPT"] = [=[JustBecomePro %s|1을;를; 설정하려면 WoW의 완전한 재시작이 필요합니다.

%s|1을;를; 찾을 수 없습니다.

지금 WoW를 재시작하시겠습니까? ]=]
L["ERROR_MISSINGFILE_OPT_NOREQ"] = [=[JustBecomePro %s|1을;를; 완벽하게 설정하려면 WoW의 완전한 재시작이 필요할 수 있습니다.

%s|1을;를; 찾을 수 없습니다.

지금 WoW를 재시작하시겠습니까? ]=]
L["ERROR_MISSINGFILE_REQFILE"] = "필요한 파일"
L["ERROR_NO_LOCKTOGGLE_IN_LOCKDOWN"] = "%q 옵션이 비활성 중이면 전투 중에 JustBecomePro을 잠금해제 할 수 없습니다 (이 옵션에 접근하려면 \"/jbp options'을 입력하세요)."
L["ERROR_NOTINITIALIZED_NO_ACTION"] = "애드온 초기 실행에 실패하면 JustBecomePro은 그 동작을 수행할 수 없습니다!"
L["ERROR_NOTINITIALIZED_NO_LOAD"] = "JustBecomePro 초기 실행에 실패하면 JustBecomePro_Options을 불러올 수 없습니다."
L["ERROR_NOTINITIALIZED_OPT_NO_ACTION"] = "애드온 초기 실행에 실패하면 JustBecomePro_Options은 그 동작을 수행할 수 없습니다."
...
고급 사용자: 카운터는 JBP.COUNTERS[counterName] = value 에 저장됩니다.  사용자 설정 Lua 스크립트에서 카운터를 변경하는 경우 JBP:Fire( "JBP_COUNTER_MODIFIED", counterName ) 를 호출하세요.]=]
...
L["EXPORT_SPECIALDESC2"] = "%s 버전을 사용 중인 다른 JustBecomePro 사용자만 이 데이터를 가져오기 할 수 있습니다"
L["EXPORT_TOCOMM"] = "플레이어에게"
L["EXPORT_TOCOMM_DESC"] = [=[편집 상자에 플레이어의 이름을 입력하고 데이터를 전송하려면 이 옵션을 선택하세요. 귓속말을 할 수 있는 사람이어야 하며(같은 진영, 서버, 접속 중), JustBecomePro v4.0.0+ 버전을 사용하고 있어야 합니다.
...
%s |T%s:0|t.]=]
L["fPROFILE"] = "프로필: %s"
L["FROMNEWERVERSION"] = "당신의 버전보다 최신 버전의 JustBecomePro에서 생성된 데이터를 가져왔습니다. 최신 버전으로 업그레이드 하기 전까지 몇몇 설정은 작동하지 않을 수 있습니다."
L["fTEXTLAYOUT"] = "문자 레이아웃: %s"
L["GCD"] = "전역 재사용 대기시간"
L["GCD_ACTIVE"] = "GCD 활성 상태"
L["GENERIC_NUMREQ_CHECK_DESC"] = "%s|1을;를; 활성화하고 설정하려면 체크하세요."
L["GENERICTOTEM"] = "토템 %d"
L["GLOBAL_GROUP_GENERIC_DESC"] = "이 WoW 계정의 모든 JustBecomePro 프로필에 |cff00c300공통|r 그룹을 사용할 수 있습니다."
...
L["GUIDCONFLICT_DESC_PART1"] = [=[JustBecomePro은 다음 항목이 동일한 전역 고유 식별자(GUID)를 가지고 있는 걸 감지했습니다. 다른 아이콘이나 그룹에서 참조하려는 경우 많은 문제를 야기할 수 있습니다 (예. 메타 아이콘의 대상을 만드는 경우).
...
JustBecomePro v7.0.0+ 사용자는 모든 문자열을 한번에 복사하여 가져오기 할 수 있습니다. 하위 버전의 사용자는 각 문자열을 개별적으로 붙여넣기 해야 합니다.]=]
...
L["HELP_SCROLLBAR_DROPDOWN"] = [=[JustBecomePro의 드롭다운 메뉴 중 몇몇은 스크롤바입니다.
...
L["ICONMENU_GROUPUNIT_DESC"] = [=[JustBecomePro에서 그룹은 공격대에 속해 있다면 공격대원을, 파티에 속해 있다면 파티원을 추적하는 특별한 유닛입니다.
...
아이콘은 JustBecomePro이 잠겨있을 때만 작동합니다, 따라서 완료 후 '/jbp'를 입력하세요.

JustBecomePro을 설정할 때 각 설정의 툴팁을 읽어보세요. 툴팁은 설정 방법에 대한 중요한 정보를 포함하고 있습니다!]=]
...
L["IMPORT_FROMCOMM_DESC"] = "다른 JustBecomePro 사용자가 당신에게 구성 데이터를 보내면, 이 메뉴를 통해서 해당 데이터를 가져올 수 있습니다."
L["IMPORT_FROMLOCAL"] = "프로필에서"
L["IMPORT_FROMSTRING"] = "문자열에서"
L["IMPORT_FROMSTRING_DESC"] = [=[JustBecomePro 구성 데이터를 게임 외부로 전송할 수 있는 문자열입니다.

문자열로부터 가져오려면, 클립보드에 문자열을 복사한 후 CTRL+V를 눌러 문자열을 편집상자에 붙여넣기한 후, 이 하위메뉴로 돌아오세요.]=]
L["IMPORT_GROUPIMPORTED"] = "그룹 가져옴!"
L["IMPORT_GROUPNOVISIBLE"] = "그룹 구성과 당신의 현재 직업과 전문화때문에 가져오기 한 그룹이 표시되지 않습니다. JBP의 그룹 옵션에서 설정을 확인하세요 - '/jbp options'."
...
L["IMPORT_LUA_DESC"] = [=[가져오기한 데이터에 JustBecomePro이 실행할 수 있는 Lua 코드를 포함하고 있습니다.
...
L["IMPORT_LUA_DESC2"] = "|TInterface/AddOns/JustBecomePro/Textures/Alert:0:2|t 빨간색 코드 부분을 살펴보세요, 보통 악의적 활동을 나타내는 단어/구문입니다. |TInterface/AddOns/JustBecomePro/Textures/Alert:0:2|t"
...
L["IMPORTERROR_INVALIDTYPE"] = "알 수 없는 유형의 데이터를 가져오려고 시도했습니다. 최신 버전의 JustBecomePro이 설치되어 있는지 확인해보세요."
...
L["LEFT"] = "좌측"
L["LOADERROR"] = "JustBecomePro_Options를 불러올 수 없습니다: "
L["LOADINGOPT"] = "JustBecomePro_Options를 불러옵니다."
L["LOCKED"] = "잠금"
L["LOCKED2"] = "위치가 잠겼습니다."
...
입력문은 'if .. then' 구문이 아니며, 종결 함수도 아닙니다. 평가하기 위한 일반적인 구문입니다, 예. 'a and b or c'. 복합 함수가 필요하다면, 외부에서 정의한 함수를 호출하세요, 예. 'CheckStuff()' (아마도 JBP의 Lua 코드 조각 기능을 사용하여).
...
L["MESSAGERECIEVE"] = "%s님이 JustBecomePro 데이터를 보냈습니다! 아이콘 편집기의 하단에 위치한 %q 버튼을 사용하여 데이터를 JustBecomePro으로 가져올 수 있습니다."
L["MESSAGERECIEVE_SHORT"] = "%s님이 JustBecomePro 데이터를 보냈습니다!"
...
타이머 이름과 정확히 일치시키려면, ^timer name$ 을 입력하세요. JBP는 타이머 이름을 소문자로 저장하므로, 이 이름은 소문자로 타이머 이름과 반드시 일치해야 합니다.
...
L["MP5"] = "%d MP5"
L["MUSHROOM"] = "%d 버섯"
L["NEWVERSION"] = "JustBecomePro의 새 버전이 이용 가능합니다: %s"
L["NOGROUPS_DIALOG_BODY"] = [=[당신의 현재 JustBecomePro 구성과/또는 플레이어 전문화가 어떤 JustBecomePro 그룹도 표시되도록 허용하지 않았습니다, 따라서 설정할 것이 없습니다.

존재하는 그룹의 설정을 변경하거나 새로운 그룹을 만드려면, '/jbp options'를 입력하여 JustBecomePro의 그룹 옵션을 열거나 하단의 버튼을 클릭하세요.

'/jbp'를 입력하면 설정 모드를 종료합니다.]=]
...
또한, JustBecomePro의 주 옵션에서 사용하도록 설정한 소리 채널을 변경할 수 있습니다 ('/jbp options')]=]
...
|TInterface/AddOns/JustBecomePro/Textures/Alert:0:2|t|cffffa500주의: |TInterface/AddOns/JustBecomePro/Textures/Alert:0:2|t|cffff1111 이 주문은 동등성과 문제가 있습니다. 아마도 이름으로 삽입하면 추적할 수 없는 것 같습니다. 대신 ID를 삽입하세요.|r]=]
...
L["SUG_TOOLTIPTITLE"] = [=[입력하는 동안 JustBecomePro은 캐시를 살펴보고 가장 가능성이 높은 주문을 결정합니다.

주문은 아래 목록 별로 분류되고 색상화됩니다. "알려진" 단어로 시작하는 범주에는 다른 직업으로 플레이하거나 접속해서 확인하기 전까지 주문을 넣을 수 없습니다.

항목을 클릭하면 편집상자에 삽입합니다.]=]
L["SUG_TOOLTIPTITLE_GENERIC"] = [=[입력하는 동안 JustBecomePro은 캐시를 살펴보고 가장 가능성이 높은 주문을 결정합니다.

이 목록은 항상 철저하지 않습니다 - 몇몇 상황에서 나타나지 않는 올바른 입력이 있을 수 있습니다. 추천 목록에 있는 항목을 사용하지 않아도 됩니다 - 편집상자에 올바른 문자만 입력하면 JustBecomePro은 문제없이 허용합니다.
...
L["TABGROUP_GROUP_DESC"] = "JustBecomePro 그룹을 설정합니다."
L["TABGROUP_ICON_DESC"] = "JustBecomePro 아이콘을 설정합니다."
L["TABGROUP_MAIN_DESC"] = "일반 JustBecomePro 설정을 구성합니다."
L["TEXTLAYOUTS"] = "문자 배치"
...
L["TEXTLAYOUTS_NOEDIT_DESC"] = [=[이 문자 배치는 JustBecomePro 표준으로 제공되는 배치이며, 편집할 수 없습니다.
...
결과적으로, 이 배치를 Masque로 스킨을 입힌 JustBecomePro 아이콘에 사용하면 아래의 설정은 적용되지 않습니다.]=]
...
L["TEXTLAYOUTS_USEDBY_NONE"] = "이 배치는 JustBecomePro 프로필 중 어떤 것에도 사용되지 않습니다."
L["TEXTMANIP"] = "문자 조작"
L["TOOLTIPSCAN"] = "효과 변수"
...
L["UIPANEL_COMBATCONFIG_DESC"] = [=[전투 중에도 JustBecomePro을 설정할 수 있게 허용합니다.
...
L["UIPANEL_GROUPTYPE_ICON_DESC"] = "JustBecomePro의 고유 아이콘 표시 방법을 사용하여 그룹 안의 아이콘을 표시합니다."
...
또한 잠금/잠금 해제하기 위해 /justbecomepro 또는 /jbp를 입력할 수 있습니다.]=]
...
L["UIPANEL_WARNINVALIDS_DESC"] = [=[이 설정을 사용하면 JustBecomePro이 아이콘에서 올바르지 않은 구성을 감지했을 때 당신에게 경고합니다.
...
L["CACHING"] = [=[JustBecomePro armazena e filtra todos os feitiços no jogo. Isto precisa apenas será feito uma vez por patch. Você pode aumentar ou diminuir o processo usando a barra deslizante. 

Você não tem que aguardar este processo terminar para usar o JustBecomePro. Apenas a lista de sugestões é dependente da conclusão do armazenamento em cache.]=]
L["CACHINGSPEED"] = "Feitiço por quadro"
L["CASTERFORM"] = "Forma Conjuradora"
L["CENTER"] = "Centro"
L["CHANGELOG"] = "Registro de Mudanças"
L["CHANGELOG_DESC"] = "Exibe uma lista das mudanças feitas na versão atual e anterior do JustBecomePro."
L["CHANGELOG_INFO2"] = [=[Bem-Vindo ao JustBecomePro v%s!
<br/><br/>
...
NÃO funciona com: |TInterface/AddOns/JustBecomePro/Textures/Alert:0:2|t
...
L["CONFIGMODE"] = "JustBecomePro está em modo de ajuste. Os ícones não funcionarão enquanto você não sair deste modo. Digite '/justbecomepro' ou '/jbp' para alternar alternar os modos."
...
L["elite"] = "Elite"
L["ENABLINGOPT"] = "JustBecomePro_Options está desativado. Ativando..."
L["Enraged"] = "Enraivecer"
L["ERROR_MISSINGFILE"] = [=[Reinicie o WoW completamente para usar o JustBecomePro %s 

%s não foi encontrado.

Gostaria de reiniciar o WoW agora ?]=]
L["ERROR_MISSINGFILE_NOREQ"] = [=[A reinicialização do WoW pode ser necessária para usar o JustBecomePro

%s não foi encontrado.

Você gostaria de reiniciar o WoW agora?]=]
L["ERROR_MISSINGFILE_REQFILE"] = "Um arquivo necessário"
L["ERROR_NOTINITIALIZED_NO_ACTION"] = "JustBecomePro não pode executar esta ação se o addon falhou ao inicializar!"
L["ERROR_NOTINITIALIZED_NO_LOAD"] = "JustBecomePro_Options não foi carregado então o JustBecomePro falha na inicialização!"
...
L["EXPORT_TOCOMM_DESC"] = [=[Digite o nome do jogador e escolha esta opção para enviar os dados. Devem ser alguém que você possa enviar um sussurro (Mesma facção, servidor e esteja online), e eles devem ter o JustBecomePro v4.0.0 ou mais recente.
...
L["fPROFILE"] = "Perfil: %s"
L["FROMNEWERVERSION"] = "Você importou dados que foram criados em uma versão mais recente do JustBecomePro. Algumas configurações podem não funcionar até você atualizar para a última versão."
...
L["IMPORT_FROMCOMM_DESC"] = "Se outro usuário do JustBecomePro enviar alguns dados de configuração, você poderá permitir a importação destes dados  a partir deste submenu."
L["IMPORT_FROMLOCAL"] = "Do Perfil"
L["IMPORT_FROMSTRING"] = "Da String"
L["IMPORT_FROMSTRING_DESC"] = [=[As Strings permitem você transferir os dados de configuração do JustBecomePro para fora do jogo.
...
L["LEFT"] = "Esquerda"
L["LOADERROR"] = "JustBecomePro_Options não pôde ser carregado:"
L["LOADINGOPT"] = "Carregando JustBecomePro_Options."
L["LOCKED"] = "Travado"
...
L["MAINTANK"] = "Tanque Principal"
L["MESSAGERECIEVE"] = "%s enviou-lhe alguns dados do JustBecomePro! Você pode importar esses dados para o JustBecomePro usando o botão %q, localizado na parte inferior do editor de ícones."
L["MESSAGERECIEVE_SHORT"] = "%s enviou algum dado do JustBecomePro!"
...
L["NEWVERSION"] = "Disponível a nova versão do JustBecomePro: %s"
...
L["SUG_TOOLTIPTITLE"] = [=[Conforme você digita, o JustBecomePro pesquisará seu cache e determinará as habilidades pelas quais você provavelmente está procurando.
...
L["UIPANEL_COMBATCONFIG_DESC"] = [=[Ativar isto permite configurar o JustBecomePro enquanto estiver em combate.
...
L["UIPANEL_GROUPTYPE_ICON_DESC"] = "Exibe os ícones no grupo usando o modo tradicional do JustBecomePro."
...
Você também pode digitar /justbecomepro ou /jbp para travar/destravar.]=]
L["UIPANEL_TALENTLEARNED"] = "Talento aprendido"
...
L["ALLOWCOMM_DESC"] = "Позволяет другим пользователям JustBecomePro выслать вам данные"
L["ALLOWVERSIONWARN"] = "Сообщать о новой версии"
L["ALPHA"] = "Альфа"
L["ANCHOR_CURSOR_DUMMY"] = "Макет якоря курсора JustBecomePro"
...
L["CACHING"] = "JustBecomePro считывает и фильтрует все умения/заклинания в игре. Это нужно делать только один раз в каждом дополнении WoW. Вы можете увеличивать или уменьшать скорость процесса, используя ползунок внизу."
L["CACHINGSPEED"] = "Умения/заклинания по названию:"
L["CASTERFORM"] = "Может произносить заклинания"
L["CENTER"] = "В центре"
L["CHANGELOG"] = "Список изменений"
L["CHANGELOG_DESC"] = "Отображает список изменений, внесенных в текущей и предыдущих версиях JustBecomePro."
L["CHANGELOG_INFO2"] = [=[Добро пожаловать в JustBecomePro версия %s!
<br/><br/>
...
L["CNDT_UNKNOWN_DESC"] = "Ваши параметры содержат состояние с названием %s, но такого состояния не найдено. Возможно Вы используете старую версию JBP, или данное состояние было удалено."
...
L["CODESNIPPET_AUTORUN_DESC"] = "Если включено, этот отрывок будет запущен когда включается JBP_INITIALIZE  (что происходит вовремя входи игрока в игру, но до создания любых групп и иконок)."
...
L["CODESNIPPETS_DESC"] = [=[Эта функция позволяет писать куски кода на lua, который будет выполнен, когда JustBecomePro инициализируется.

Это расширенная функция для тех, кто имеет опыт работы с Lua (или для тех, кому был предоставлен фрагмент другим пользователям JustBecomePro).
...
Чтобы вставить, ссылку на значок JustBecomePro в ваш код, |cff7fffffshift-щелчок|r на этот значок.]=]
L["CODESNIPPETS_DESC_SHORT"] = "Писать куски кода на lua, который будет выполнен, когда JustBecomePro инициализируется."
...
L["CONFIGMODE"] = "JustBecomePro в режиме настройки. Значки не будут работать до выхода из режима настройки. Наберите /jbp для включения/выключения режима настройки."
...
L["elite"] = "Элитный"
L["ENABLINGOPT"] = "Дополнение JustBecomePro_Options отключено. Включаю ..."
L["Enraged"] = "Энрейдж"
L["ERROR_MISSINGFILE"] = "Для использования JustBecomePro %s необходима перезагрузка WoW (%s не найден). Перезагрузить WoW сейчас?"
L["ERROR_MISSINGFILE_NOREQ"] = [=[Может понадобиться полный перезапуск игры, чтобы использовать JustBecomePro %s:

%s не найден.

Хотите перезапустить WoW сейчас?]=]
L["ERROR_MISSINGFILE_REQFILE"] = "Требуемый файл"
L["ERROR_NOTINITIALIZED_NO_ACTION"] = "JustBecomePro не может произвести это действие, если аддон не удалось инициализировать!"
L["ERROR_NOTINITIALIZED_NO_LOAD"] = "JustBecomePro_Options не может быть загружен, если аддон не удалось инициализировать!"
...
L["EXPORT_SPECIALDESC2"] = "Другие пользователи JustBecomePro могут импортировать эти данные только в том случае, если они имеют версию %s"
L["EXPORT_TOCOMM"] = "Игроку"
L["EXPORT_TOCOMM_DESC"] = [=[Введите имя игрока в поле и выберите эту опцию чтобы переслать ему настройки. Игрок должен быть доступен для команды /whisper (та же фракция и сервер что и вы, быть в онлайне) и обладать JustBecomePro версии 4.0.0 и выше.
...
L["FROMNEWERVERSION"] = "Вы импортируете данные созданные в более новой версии JustBecomePro. Некоторые установки не будут работать пока вы не обновите JustBecomePro до последней версии."
...
L["IMPORT_FROMSTRING_DESC"] = [=[Строки позволяют пользователям обмениваться настройками JustBecomePro.
...
L["LEFT"] = "Влево"
L["LOADERROR"] = "Дополнение JustBecomePro_Options не может быть загружено:"
L["LOADINGOPT"] = "Загрузка JustBecomePro_Options."
L["LOCKED"] = "Закреплено"
...
L["MAINTANK"] = "Осн. танк"
L["MESSAGERECIEVE"] = "%s прислал(а) вам строку данных JustBecomePro. Вы можете импортировать эти данные в JustBecomePro используя выпадающий список %q в редакторе значков."
L["MESSAGERECIEVE_SHORT"] = "%s прислал(а) вам строку данных JustBecomePro!"
...
L["MP5"] = "%d MP5"
L["MUSHROOM"] = "Гриб %d"
L["NEWVERSION"] = "Доступна новая версия JustBecomePro: %s"
...
L["SUG_TOOLTIPTITLE"] = [=[При вводе текста JustBecomePro будет показывать наиболее подходящие заклинания и способности.
...
Для блокировки/разблокировки аддона наберите /justbecomepro or /jbp.]=]
...
L["AIR"] = "空气图腾"
L["ALLOWCOMM"] = "允许图标导入"
L["ALLOWCOMM_DESC"] = "允许另一个JustBecomePro使用者给你发送数据."
L["ALLOWVERSIONWARN"] = "新版本通知"
L["ALPHA"] = "透明度"
L["ANCHOR_CURSOR_DUMMY"] = "JustBecomePro鼠标指针"
...
你也能使用放在WoW目录中的自定义材质(请在该字段输入材质的相对路径,像是'jbp/ccc.tga'),仅支持尺寸为2的N次方(32, 64, 128,等)并且类型为.tga和.blp的材质文件.]=]
...
L["CACHING"] = [=[JustBecomePro正在缓存和筛选游戏中的所有法术.
这只需要在每次魔兽世界补丁升级之后完成一次.您可以使用下方的滑杆加快或减慢过程.]=]
L["CACHINGSPEED"] = "法术缓存速度(每帧法术):"
L["CASTERFORM"] = "施法者形态"
L["CENTER"] = "居中"
L["CHANGELOG"] = "更新日志"
L["CHANGELOG_DESC"] = "显示JustBecomePro当前和之前版本的变动列表."
L["CHANGELOG_INFO2"] = [=[欢迎使用 JustBecomePro v%s!
<br/><br/>
在你确认完变更信息后, 点击标签 %s 或底部的标签 %s 开始设置JustBecomePro.]=]
...
L["CNDT_UNKNOWN_DESC"] = "你的设置中有一个名为%s的标识无法找到对应的条件。可能是因为使用了旧版本的JBP或者该条件已经被移除。"
...
L["CODESNIPPETS_DESC"] = [=[此功能允许你编写Lua代码并在JustBecomePro加载时执行.

它是一个高级功能,可以让Lua熟练工如鱼得水,也可以让完全不懂Lua的人导入其他JustBecomePro使用者分享出来的片段.

可用在像是编写一个特定的过程用于Lua条件中(必须把它们定义在JBP.CNDT.Env).

片段可被定义为角色专用或公用(共用片段会在所有角色执行).]=]
L["CODESNIPPETS_DESC_SHORT"] = "输入的LUA代码会在JustBecomePro加载的时候运行。"
...
L["CONDITIONS"] = "条件"
L["CONFIGMODE"] = "JustBecomePro正处于设置模式. 在离开设置模式之前,图标无法正常使用. 输入'/justbecomepro'或'/jbp'可以开启或关闭设置模式."
L["CONFIGMODE_EXIT"] = "退出设置模式"
L["CONFIGMODE_EXITED"] = "JBP已锁定。输入/jbp重新进入设置模式。"
...
L["DamageShield"] = "伤害护盾"
L["DBRESTORED_INFO"] = [=[JustBecomePro检测到数据库为空或者已损坏。 造成这个最可能的原因是WoW没有正常退出。

JustBecomePro_Options对数据库多备份了一次，以防止这样的情况发生，因为很少会出现JustBecomePro和JustBecomePro_Options的数据库同时损坏。
...
L["DT_DOC_Counter"] = "返回JustBecomePro计数器的值。图标通知消息会创建或修改计数器。"
L["DT_DOC_Destination"] = "返回图标最后一次处理的战斗事件中的目标单位或名称.和[Name]标签一起使用效果更佳.(此标签仅可用于图标类型%s)"
L["DT_DOC_Duration"] = "返回图标当前的剩余持续时间.推荐你使用[JBPFormatDuration]."
...
L["DT_DOC_Timer"] = "返回JustBecomePro计时器的值。计时器一般在图标的通知事件中被创建或更改。"
L["DT_DOC_JBPFormatDuration"] = "返回一个由JustBecomePro的时间格式处理过的字符串​​.用于替代[FormatDuration]."
...
L["elite"] = "精英"
L["ENABLINGOPT"] = "JustBecomePro设置已禁用.重新启用中...."
...
L["ERROR_ACTION_DENIED_IN_LOCKDOWN"] = "无法在战斗中这么做,请先启用%q选项(输入'/jbp options'或'/jbp 选项')."
L["ERROR_ANCHOR_CYCLICALDEPS"] = "%s尝试依附到%s，但是%s的位置依赖于%s的位置，为了防止出错JustBecomePro会将它重置到屏幕的中央。"
L["ERROR_ANCHORSELF"] = "%s尝试附着于它自己, 所以JustBecomePro会重置它的附着位置到屏幕中间以防止出现严重的错误."
L["ERROR_INVALID_SPELLID2"] = "一个图标正在检测一个无效的法术ID: %s. 为免图标发生错误,请移除它!"
L["ERROR_MISSINGFILE"] = "JustBecomePro需要在重开魔兽世界之后才能正常使用%s (原因:无法找到 %s ). 你要马上重开魔兽世界吗?"
L["ERROR_MISSINGFILE_NOREQ"] = "JustBecomePro需要在重开魔兽世界之后才能完全正常使用%s (原因:无法找到 %s ). 你要马上重开魔兽世界吗?"
L["ERROR_MISSINGFILE_OPT"] = [=[需要在重开魔兽世界之后才能设置JustBecomePro %s。

原因：无法找到%s。

你要马上重开魔兽世界吗？ ]=]
L["ERROR_MISSINGFILE_OPT_NOREQ"] = [=[可能需要在重开魔兽世界之后才能全面设置JustBecomePro %s。

原因：无法找到%s。

你要马上重开魔兽世界吗？ ]=]
L["ERROR_MISSINGFILE_REQFILE"] = "一个必需的文件"
L["ERROR_NO_LOCKTOGGLE_IN_LOCKDOWN"] = "无法在战斗中解锁JustBecomePro,请先启用%q选项(输入'/jbp options'或'/jbp 选项')."
L["ERROR_NOTINITIALIZED_NO_ACTION"] = "插件初始化失败,JustBecomePro不能执行该步骤."
L["ERROR_NOTINITIALIZED_NO_LOAD"] = "插件初始化失败,JustBecomePro_Options无法加载."
L["ERROR_NOTINITIALIZED_OPT_NO_ACTION"] = "如果插件初始化失败，JustBecomePro_Options将无法执行该动作！"
L["ERRORS_FRAME"] = "错误框架"
...
高玩用户：计数器储存在JBP.COUNTERS[counterName] = value中。如果你想在自定义Lua语言脚本中更改一个计数器可调用 JBP:Fire( "JBP_COUNTER_MODIFIED", counterName )。]=]
...
L["EXPORT_f"] = "导出 %s"
L["EXPORT_HEADING"] = "导出"
L["EXPORT_SPECIALDESC2"] = "其他JustBecomePro使用者只能在他们所使用的版本高于或等于%s时才能导入这些数据."
L["EXPORT_TOCOMM"] = "到玩家"
L["EXPORT_TOCOMM_DESC"] = [=[输入一个玩家的名字到编辑框同时选择此选项来发送数据给他们.他们必须是你能密语的某人(同阵营,同服务器,在线),同时他们必须已经安装版本为4.0.0+的JustBecomePro.
...
%s |T%s:0|t]=]
L["fPROFILE"] = "配置文件: %s"
L["FROMNEWERVERSION"] = "你导入的数据为版本较新的JustBecomePro所创建,某些设置在更新至最新版本之前可能无法正常使用."
L["fTEXTLAYOUT"] = "文字显示样式: %s"
L["GCD"] = "公共冷却"
L["GCD_ACTIVE"] = "公共冷却作用中"
L["GENERIC_NUMREQ_CHECK_DESC"] = "勾选以启用并配置%s"
L["GENERICTOTEM"] = "图腾 %d"
L["GLOBAL_GROUP_GENERIC_DESC"] = "|cff00c300共用分组|r是指在你这个魔兽世界帐号中的JustBecomePro配置文件的所有角色都可共同使用的分组。"
...
L["GUIDCONFLICT_DESC_PART1"] = [=[JustBecomePro检测到下列的对象拥有相同的全局唯一标识符（GUID）。如果你从它们其中之一调用数据可能会发生料想不到问题（例如：将它们之中的一个加入到整合图标中）。
...
JustBecomePro版本7.0.0+的使用者可以一次导入所有数据。其他人需要分开多次导入字符串。]=]
...
L["HELP_SCROLLBAR_DROPDOWN"] = [=[一些JustBecomePro的下拉菜单有滚动条。
...
|cff00d1ff自定义|r
|cffff0000你也能使用放在WoW下的子目录中的自定义材质(请在该字段输入材质的相对路径,像是'jbp/ccc.tga'),仅支持尺寸为2的N次方(32, 64, 128,等)并且类型为.tga和.blp的材质文件.]=]
...
译者注:如果你设置为20, 那JustBecomePro显示的计时条的总长度将变成20秒,但是并不影响你实际的计时,事实上法术的持续时间还是10秒,只是倒计时会从那个20秒长的计时条的中间开始.]=]
L["ICONMENU_FOCUS"] = "焦点目标"
L["ICONMENU_FOCUSTARGET"] = "焦点目标的目标"
L["ICONMENU_FRIEND"] = "友好单位"
L["ICONMENU_GROUPUNIT_DESC"] = [=[Group是JustBecomePro中一个特殊的单位，用于你在团队时检测团队成员，或你在队伍时检测队伍成员。
...
图标只能在锁定状态才能正常运作,当你设置结束后记得输入"/JBP".


在设置JustBecomePro时,请仔细阅读每个设置选项的提示信息,里面会有如何设置的关键信息,可以让你事半功倍!]=]
...
L["IMPORT_FROMCOMM_DESC"] = "如果其他JustBecomePro使用者给你发送了配置数据,可以从这个子菜单导入那些数据."
L["IMPORT_FROMLOCAL"] = "来自配置文件"
L["IMPORT_FROMSTRING"] = "来自字符串"
L["IMPORT_FROMSTRING_DESC"] = [=[字符串允许你在游戏以外的地方转存JustBecomePro配置数据.(包括用来给其他人分享自己的设置,或者导入其他人分享的设置,也可用来备份你自己的设置.)

从字符串导入的方法: 当复制JBP字符串到你的剪切板后,在'导出/导入'编辑框中按下CTRL+V贴上字符串,然后返回浏览这个子菜单.]=]
L["IMPORT_GROUPIMPORTED"] = "分组已导入！"
L["IMPORT_GROUPNOVISIBLE"] = "你刚刚导入的分组无法显示，因为它的设置似乎不是你当前的专精和职业所使用。请输入'/jbp options'，在分组设置中修改专精和职业设置。"
L["IMPORT_HEADING"] = "导入"
L["IMPORT_ICON_DISABLED_DESC"] = "你必须在设置一个图标的时候才能导入一个图标."
L["IMPORT_LUA_CONFIRM"] = "确定导入"
L["IMPORT_LUA_DENY"] = "取消导入"
L["IMPORT_LUA_DESC"] = [=[导入的数据中包含了以下Lua代码可以被JustBecomePro执行。

你需要警惕导入的Lua代码的来源是否可信，大部分情况下它们都是安全的，但是知人知面不知心，不要被少数坏人有机可乘。

注意检查并确认代码来自可信的地方，以及它们不会做像是以你的名义来发送邮件或者确认交易这种事情。]=]
L["IMPORT_LUA_DESC2"] = "|TInterface\\AddOns\\JustBecomePro\\Textures\\Alert:0:2|t 请注意检视红色部分代码，它们可能会有某些恶意行为。|TInterface\\AddOns\\JustBecomePro\\Textures\\Alert:0:2|t"
L["IMPORT_NEWGUIDS"] = [=[你刚导入的数据中的%d|4分组:分组;和%d|4图标:图标;有唯一标识符。可能是因为你之前已经导入过该数据。

JustBecomePro已经为导入的数据分配了新的标识符。你在这之后导入的那些图标都将引用新的数据，可能会无法正常使用 - 新数据会使用到老的图标数据而造成混乱。
...
L["IMPORTERROR_INVALIDTYPE"] = "尝试导入未知类型的数据,请检查是否已安装了最新版本的JustBecomePro."
L["Incapacitated"] = "被瘫痪"
L["INCHEALS"] = "单位受到的治疗量"
...
L["LEFT"] = "左"
L["LOADERROR"] = "JustBecomePro设置插件无法加载:"
L["LOADINGOPT"] = "正在加载JustBecomePro设置插件."
L["LOCKED"] = "已锁定"
L["LOCKED2"] = "位置锁定."
...
L["MESSAGERECIEVE"] = "%s给你发送了一些JustBecomePro数据!你可以使用图标编辑器中的 %q 下拉式菜单把数据导入JustBecomePro."
L["MESSAGERECIEVE_SHORT"] = "%s给你发送了一些JustBecomePro数据!"
L["META_ADDICON"] = "增加图标"
...
输入^timer name$时将强制匹配计时器的完整名称。JustBecomePro保存计时器的名称必须全部为小写字母。
...
L["NOGROUPS_DIALOG_BODY"] = [=[你当前的JustBecomePro设置或玩家专精不允许显示任何分组，所以没有东西可以进行设置。

如果你想更改已有分组的设置或新增一个分组，请输入/jbp options打开JustBecomePro的首选项或者点击下方的按键。

输入/justbecomepro或/jbp退出设置模式。 ]=]
L["NONE"] = "不包含任何一个"
L["normal"] = "普通"
L["NOTINRANGE"] = "不在范围内"
L["NOTYPE"] = "<无图标类型>"
...
你需要去更改暴雪音效选项的相关设置，或者你也可以在JustBecomePro的主选项中更改JustBecomePro的音效播放频道('/jbp options')。]=]
...
|TInterface\AddOns\JustBecomePro\Textures\Alert:0:2|t|cffffa500CAUTION: |TInterface\AddOns\JustBecomePro\Textures\Alert:0:2|t|cffff1111
此法术可能有多个效果。
如果使用名称可能无法被正确的检测。
你应当使用一个ID来检测。|r]=]
...
L["SUG_TOOLTIPTITLE"] = [=[当你输入时,JustBecomePro将会在缓存中查找并提示你最有可能输入的法术.
...
L["SUG_TOOLTIPTITLE_GENERIC"] = [=[当你输入时，JustBecomePro会尝试确定你想要输入的内容。

在某些情况下，建议列表中可能显示了错误的内容。你可以不用选择建议列表中的条目 - 当你输入编辑框的（正确）内容越长时，JustBecomePro越不容易发生这样的情况。
...
L["SUN"] = "日蚀"
L["SWINGTIMER"] = "攻击计时"
L["TABGROUP_GROUP_DESC"] = "设置 JustBecomePro 分组."
L["TABGROUP_ICON_DESC"] = "设置 JustBecomePro 图标."
L["TABGROUP_MAIN_DESC"] = "JustBecomePro综合设置"
...
L["TEXTLAYOUTS_NOEDIT_DESC"] = [=[这个文字显示样式是JustBecomePro默认的文字显示样式,你无法对其作出更改.
...
因此，当此布局用于由Masque设置外观的JustBecomePro图标时，下面的设置不会有任何效果。]=]
...
L["TEXTLAYOUTS_USEDBY_NONE"] = "此魔兽世界帐号中的JustBecomePro配置文件中没有使用这个显示样式。"
L["TEXTMANIP"] = "文字处理"
...
L["UIPANEL_COMBATCONFIG_DESC"] = [=[启用这个选项就可以在战斗中对JustBecomePro进行设置.
...
L["UIPANEL_GROUPTYPE_ICON_DESC"] = "分组使用JustBecomePro传统的图标方式来显示."
...
你可以输入'/justbecomepro'或'/jbp'来锁定/解除锁定.]=]
...
L["UIPANEL_WARNINVALIDS_DESC"] = [=[如果勾选此项， JustBecomePro会在检测到你的图标存在无效的设置时警告你。
...
L["AIR"] = "風之圖騰"
L["ALLOWCOMM"] = "允許圖示匯入"
L["ALLOWCOMM_DESC"] = "允許另一個JustBecomePro使用者給你發送數據。"
L["ALLOWVERSIONWARN"] = "新版本通知"
L["ALPHA"] = "可見度"
L["ANCHOR_CURSOR_DUMMY"] = "JustBecomePro虛擬遊標錨點"
...
你也能使用放在WoW資料夾中的自訂材質（請在該欄位輸入材質的相對路徑，如：「jbp/ccc.tga」），僅支援尺寸為2的N次方（32， 64， 128，等）並且類型為.tga和.blp的材質檔案。]=]
...
L["CACHING"] = "JustBecomePro正在快取和篩選遊戲中的所有法術。這只需要在每次魔獸世界補丁升級之後完成一次。您可以使用下方的滑桿加快或減慢過程。"
L["CACHINGSPEED"] = "法術快取速度（每幀法術）："
L["CASTERFORM"] = "施法者形態"
L["CENTER"] = "中間"
L["CHANGELOG"] = "更新紀錄"
L["CHANGELOG_DESC"] = "顯示JustBecomePro當前和之前版本的變動列表。"
L["CHANGELOG_INFO2"] = [=[歡迎使用 JustBecomePro v%s!
<br/><br/>
在你確認完更新訊息後, 點擊標簽 %s 或底部的標簽 %s 開始設置JustBecomePro。]=]
...
L["CNDT_UNKNOWN_DESC"] = "你的設定中有一個名為%s的標識無法找到對應的條件。可能是因為使用了舊版本的JBP或者該條件已經被移除。"
...
L["CODESNIPPETS_DEFAULTNAME"] = "新片段"
L["CODESNIPPETS_DESC"] = [=[此功能允許你編寫Lua程式碼並在JustBecomePro載入時執行。

它是一個進階功能，可以讓Lua熟練工如魚得水，也可以讓完全不懂Lua的人匯入其他JustBecomePro使用者分享出來的片段。

可用在像是編寫一個特定的過程用於Lua條件中（必須把它們定義在JBP.CNDT.Env）。

片段可被定義為角色專用或公用（共用片段會在所有角色執行）。]=]
L["CODESNIPPETS_DESC_SHORT"] = "輸入的LUA代碼會在JustBecomePro初始化的時候運行。"
L["CODESNIPPETS_IMPORT_GLOBAL"] = "新的共用片段"
...
L["CONDITIONPANEL_ZONEPVP_FFA"] = "自由PVP"
L["CONDITIONS"] = "條件"
L["CONFIGMODE"] = "JustBecomePro正處於設定模式。 在離開設定模式之前，圖示無法正常使用。 輸入'/justbecomepro'或'/jbp'可以開啟或關閉設定模式。"
L["CONFIGMODE_EXIT"] = "退出設定模式"
L["CONFIGMODE_EXITED"] = "JBP已鎖定。輸入/jbp重新進入設定模式。"
...
L["DamageShield"] = "傷害護盾"
L["DBRESTORED_INFO"] = [=[JustBecomePro檢測到資料庫為空或已損壞。造成此情況最可能的原因是WoW沒有正常登出。

JustBecomePro_Options對資料庫多備份了一次，以防止這樣的情況發生，因為很少會出現JustBecomePro和JustBecomePro_Options的資料庫同時損壞。
...
L["DT_DOC_Counter"] = "返回JustBecomePro計數器的值。圖示通知資訊會創建或修改計數器。"
L["DT_DOC_Destination"] = "返回圖示最後一次處理過的戰鬥事件中的目標單位或名稱。同[Name]標籤一起使用效果更佳。（此標籤僅可用於圖示類型%s）"
L["DT_DOC_Duration"] = "返回圖示當前的剩餘持續時間。推薦你使用[JBPFormatDuration]。"
...
L["DT_DOC_Timer"] = "返回JustBecomePro計時器的數值。計時器一般在圖示的通知事件中被創建或更改。"
L["DT_DOC_JBPFormatDuration"] = "返回一个由JustBecomePro的時間格式處理過的字串。用於替代[FormatDuration]。"
...
L["elite"] = "精英"
L["ENABLINGOPT"] = "JustBecomePro選項已停用。正在重新啟用中……"
...
L["ERROR_ACTION_DENIED_IN_LOCKDOWN"] = "無法在戰鬥中這麼做，請先啟用%q選項（輸入'/jbp options'或'/jbp 選項'）。"
L["ERROR_ANCHOR_CYCLICALDEPS"] = "%s嘗試依附到%s，但是%s的位置依賴於%s的位置，為了防止出錯JustBecomePro會將它重設到熒幕的中央。"
L["ERROR_ANCHORSELF"] = "%s嘗試依附於它自己，所以JustBecomePro會重設它的依附位置到螢幕中間以防止出現嚴重的錯誤。"
L["ERROR_INVALID_SPELLID2"] = "一個圖示正在檢查一個無效的法術ID：%s。 為免圖示發生錯誤，請移除它!"
L["ERROR_MISSINGFILE"] = "JustBecomePro需要在重開魔獸世界之後才能正常使用 %s （原因：無法找到%s）。 你要馬上重開魔獸世界嗎？"
L["ERROR_MISSINGFILE_NOREQ"] = "JustBecomePro需要在重開魔獸世界之後才能完全正常使用 %s （原因：無法找到%s）。 你要馬上重開魔獸世界嗎？"
L["ERROR_MISSINGFILE_OPT"] = [=[需要在重開魔獸世界之後才能設定JustBecomePro %s。

原因：無法找到%s。

你要馬上重開魔獸世界嗎？]=]
L["ERROR_MISSINGFILE_OPT_NOREQ"] = [=[可能需要在重開魔獸世界之後才能全面設定JustBecomePro %s。

原因：無法找到%s。

你要馬上重開魔獸世界嗎？]=]
L["ERROR_MISSINGFILE_REQFILE"] = "一個必需的檔案"
L["ERROR_NO_LOCKTOGGLE_IN_LOCKDOWN"] = "無法在戰鬥中解鎖JustBecomePro，請先啟用%q選項（輸入'/jbp options'或'/jbp 選項'）。"
L["ERROR_NOTINITIALIZED_NO_ACTION"] = "插件初始化失敗，JustBecomePro不能執行該步驟。 "
L["ERROR_NOTINITIALIZED_NO_LOAD"] = "插件初始化失敗，JustBecomePro_Options無法載入。"
L["ERROR_NOTINITIALIZED_OPT_NO_ACTION"] = "如果插件初始化失敗，JustBecomePro_Options將無法執行該動作！"
...
進階玩家：計數器保存在JBP.COUNTERS[counterName] = value中。如果你想在自訂Lua語言腳本中更改一個計數器，可調用JBP:Fire( "JBP_COUNTER_MODIFIED"， counterName )。]=]
...
L["EXPORT_f"] = "匯出 %s"
L["EXPORT_HEADING"] = "匯出"
L["EXPORT_SPECIALDESC2"] = "其他JustBecomePro使用者只能在他們所用的版本等於或高於%s時才可匯入這些數據。"
L["EXPORT_TOCOMM"] = "到玩家"
L["EXPORT_TOCOMM_DESC"] = [=[輸入一個玩家的名字到編輯框同時選擇此選項來發送數據給他們。他們必須是你能密語的某人（同陣營，同伺服器，在線），同時他們必須已經安裝版本為4.0.0+的JustBecomePro。
...
%s |T%s:0|t.]=]
L["fPROFILE"] = "設定檔：%s"
L["FROMNEWERVERSION"] = "你匯入的數據為版本較新的JustBecomePro所創建，某些設定在更新至最新版本之前可能無法正常使用。"
L["fTEXTLAYOUT"] = "文字顯示樣式：%s"
L["GCD"] = "公共冷卻"
L["GCD_ACTIVE"] = "公共冷卻作用中"
L["GENERIC_NUMREQ_CHECK_DESC"] = "勾選以啟用並設定%s"
L["GENERICTOTEM"] = "圖騰 %d"
L["GLOBAL_GROUP_GENERIC_DESC"] = "|cff00c300共用群組|r是指在你這個魔獸世界帳號中的JustBecomePro設定檔的所有角色都可共同使用的群組。"
...
L["GUIDCONFLICT_DESC_PART1"] = [=[JustBecomePro檢測到下列的物件擁有相同的全域唯一識別碼（GUID）。如果你從它們其中之一調用數據可能會發生料想不到問題（例如：將它們之中的一個加入到整合圖示中）。
...
JustBecomePro版本7.0.0+的使用者可以一次匯入所有數據。其他人需要分開多次匯入字串。]=]
...
L["HELP_SCROLLBAR_DROPDOWN"] = [=[一些JustBecomePro的下拉選單有捲動條。
...
|cff00d1ff自訂材質|r
你也能使用放在WoW子資料夾下的自訂材質（請在該欄位輸入材質的相對路徑，如：「jbp/ccc.tga」），僅支援尺寸為2的N次方（32， 64， 128，等）並且類型為.tga和.blp的材質檔案。]=]
...
譯者註：如果你設定為20， 那JustBecomePro顯示的計時條的總長度將變成20秒，但是並不影響你實際的計時，事實上法術的持續時間還是10秒，只是倒計時會從那個20秒長的計時條的中間開始。]=]
L["ICONMENU_FOCUS"] = "專注目標"
L["ICONMENU_FOCUSTARGET"] = "專注目標的目標"
L["ICONMENU_FRIEND"] = "友好"
L["ICONMENU_GROUPUNIT_DESC"] = [=[Group是JustBecomePro中一個特殊的單位，用於你在團隊時檢查團隊成員，或你在隊伍時檢查隊伍成員。
...
圖示只能在鎖定狀態才能正常運作，當你設定結束後記得輸入"/JBP"。


在設定JustBecomePro時，請仔細閱讀每個設定選項的提示資訊，裡面會有如何設定的關鍵訊息，可以讓你事半功倍!]=]
...
L["IMPORT_FROMCOMM_DESC"] = "如果另一個JustBecomePro使用者給你發送了組態數據，可以從這個子選單匯入那些數據。"
L["IMPORT_FROMLOCAL"] = "來自設定檔"
L["IMPORT_FROMSTRING"] = "來自字串"
L["IMPORT_FROMSTRING_DESC"] = [=[字串允許你在遊戲以外的地方轉存JustBecomePro組態數據。（包括用來給其他人分享自己的設定，或者匯入其他人分享的設定，也可用來備份你自己的設定。）

從字串匯入的方法：當複製JBP字串到你的剪貼簿後，在「匯出/匯入」編輯框中按下CTRL+V貼上字串，然後返回瀏覽這個子選單。]=]
L["IMPORT_GROUPIMPORTED"] = "群組已匯入！"
L["IMPORT_GROUPNOVISIBLE"] = "你剛剛匯入的群組無法顯示，因為它的設定似乎不是你當前的專精和職業所使用。請輸入'/jbp options'，在群組設定中修改專精和職業設定。"
L["IMPORT_HEADING"] = "匯入"
L["IMPORT_ICON_DISABLED_DESC"] = "你必須在設定一個圖示的時候才能匯入一個圖示。"
L["IMPORT_LUA_CONFIRM"] = "確定匯入"
L["IMPORT_LUA_DENY"] = "取消匯入"
L["IMPORT_LUA_DESC"] = [=[匯入的數據中包含了以下Lua程式碼可以被JustBecomePro執行。

你需要警惕匯入的Lua程式碼的來源是否可信。大部分情況下它們都是安全的，但是知人知面不知心，不要被少數壞人有機可乘。

注意檢查並確認程式碼來自可信的地方，以及它們不會做像是以你的名義來發送郵件或者確認交易這種事情。]=]
L["IMPORT_LUA_DESC2"] = "|TInterface\\AddOns\\JustBecomePro\\Textures\\Alert:0:2|t 請注意檢視紅色部分程式碼，它們可能會有某些惡意行為。 |TInterface\\AddOns\\JustBecomePro\\Textures\\Alert:0:2|t"
...
L["IMPORTERROR_INVALIDTYPE"] = "嘗試匯入未知類型的數據，請檢查是否已安裝了最新版本的JustBecomePro。"
L["Incapacitated"] = "癱瘓"
L["INCHEALS"] = "單位受到的治療量"
...
L["LEFT"] = "左"
L["LOADERROR"] = "JustBecomePro設定插件無法載入："
L["LOADINGOPT"] = "正在載入JustBecomePro設定插件。"
L["LOCKED"] = "已鎖定"
L["LOCKED2"] = "位置鎖定。"
L["LOSECONTROL_CONTROLLOST"] = "失去控制"
...
L["MESSAGERECIEVE"] = "%s給你發送了一些JustBecomePro的數據! 你可以利用圖示編輯器中的 %q 下拉式選單匯入這些數據到JustBecomePro。"
L["MESSAGERECIEVE_SHORT"] = "%s給你發送了一些JustBecomePro數據!"
L["META_ADDICON"] = "增加圖示"
...
輸入^timer name$時將強制匹配計時器的完整名稱。 JustBecomePro保存計時器的名稱必須全部為小寫字母。
...
L["NOGROUPS_DIALOG_BODY"] = [=[你當前的JustBecomePro設定或玩家專精不允許顯示任何群組，所以沒有東西可以進行設定。

如果你想更改已有群組的設定或新增一個群組，請輸入/jbp options打開JustBecomePro的首選項或者點擊下方的按鍵。

輸入/justbecomepro或/jbp退出設定模式。]=]
L["NONE"] = "不包含任何一個"
L["normal"] = "普通"
L["NOTINRANGE"] = "不在範圍內"
L["NOTYPE"] = "<無圖示類型>"
...
你需要去更改暴雪音效選項的相關設定，或者你也可以在JustBecomePro的主選項中更改JustBecomePro的音效播放頻道（/jbp options）。]=]
...
L["SUG_INSERTNAME_INTERFERE"] = [=[|TInterface\AddOns\JustBecomePro\Textures\Alert:0:2|t|cffffa500CAUTION:|TInterface\AddOns\JustBecomePro\Textures\Alert:0:2|t|cffff1111
此法術可能有多個效果。
如果使用名稱可能無法被正確的檢查。
你應當使用一個ID來檢查。 |r]=]
...
L["SUG_TOOLTIPTITLE"] = [=[當你輸入時，JustBecomePro將會在快取中查找並提示你最有可能輸入的法術。
...
L["SUG_TOOLTIPTITLE_GENERIC"] = [=[當你輸入時，JustBecomePro會嘗試確定你想要輸入的內容。

在某些情況下，建議列表中可能顯示了錯誤的內容。你可以不用選擇建議列表中的條目- 當你輸入編輯框的（正確）內容越長時，JustBecomePro越不容易發生這樣的情況。
...
L["SUN"] = "日蝕"
L["SWINGTIMER"] = "揮擊計時"
L["TABGROUP_GROUP_DESC"] = "設置 JustBecomePro 分組。"
L["TABGROUP_ICON_DESC"] = "設置 JustBecomePro 圖標。"
L["TABGROUP_MAIN_DESC"] = "JustBecomePro綜合設置"
...
L["TEXTLAYOUTS_NOEDIT_DESC"] = [=[這個文字顯示樣式是JustBecomePro預設的文字顯示樣式，你無法對其作出更改。
...
因此，當此布局用於由Masque設置外觀的JustBecomePro圖標時，下面的設置不會有任何效果。]=]
...
L["TEXTLAYOUTS_USEDBY_NONE"] = "此魔獸世界帳號中的JustBecomePro設定檔中沒有使用這個顯示樣式。"
L["TEXTMANIP"] = "文字處理"
...
L["UIPANEL_COMBATCONFIG_DESC"] = [=[啟用這個選項就可以在戰鬥中對JustBecomePro進行設定。
...
L["UIPANEL_GROUPTYPE_ICON_DESC"] = "群組使用JustBecomePro傳統的圖示方式來顯示。"
...
你可以輸入「/justbecomepro」或「/jbp」來鎖定、解鎖。]=]
...
L["UIPANEL_WARNINVALIDS_DESC"] = [=[如果勾選此項， JustBecomePro會在檢測到你的圖標存在無效的設置時警告你。
