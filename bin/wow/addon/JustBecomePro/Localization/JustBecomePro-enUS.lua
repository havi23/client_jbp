...
local L = LibStub("AceLocale-3.0"):NewLocale("JustBecomePro", "enUS", true)
...
L["GLOBAL_GROUP_GENERIC_DESC"] = "|cff00c300Global|r groups are available to all your JustBecomePro profiles on this WoW account."
...
Type '/jbp' to leave configuration mode.]]
...
L["LOADERROR"] = "JustBecomePro_Options could not be loaded: "
L["LOADINGOPT"] = "Loading JustBecomePro_Options."
L["ENABLINGOPT"] = "JustBecomePro_Options is disabled. Enabling..."
L["CONFIGMODE"] = "JustBecomePro is in configuration mode. Icons will not be functional until you leave configuration mode. Type '/justbecomepro' or '/jbp' to toggle configuration mode on and off."
L["CONFIGMODE_EXIT"] = "Exit config mode"
L["CONFIGMODE_EXITED"] = "JBP is now locked. Type /jbp to enter config mode again."
L["CONFIGMODE_NEVERSHOW"] = "Don't show again"
L["IMPORT_SUCCESSFUL"] = "Import successful!"
L["IMPORT_FAILED"] = "Import failed!"
L["IMPORTERROR_INVALIDTYPE"] = "Attempted to import data of an unknown type. Check to see if you have the latest version of JustBecomePro installed."
...
L["DBRESTORED_INFO"] = [[JustBecomePro has detected that its database was either empty or corrupted. This can be caused by a number of issues, the most common of which is WoW not exiting properly.

JustBecomePro_Options maintains a backup of your database in case this happens. The current backup was created on:
...
L["CHANGELOG_DESC"] = "Displays a list of changes made in current and past versions of JustBecomePro."
L["CHANGELOG_LAST_VERSION"] = "Previous Installed Version"


L["NOGROUPS_DIALOG_BODY"] = [[Your current JustBecomePro configuration and/or player specialization does not allow any JustBecomePro groups to be shown, so there is nothing to configure.

If you would like to change the settings of an existing group or create a new group, open JustBecomePro's group options by typing '/jbp options' or click the button below.

Type '/jbp' to leave configuration mode.]]
L["MAINOPTIONS_SHOW"] = "Show Main Options"

L["GUIDCONFLICT_DESC_PART1"] = [[JustBecomePro has detected that the following things have the same globally-unique identifier (GUID). This can cause quite a few issues if you want to reference either one from another icon or group (E.g. making one the target of a meta icon).
...
L["ERROR_MISSINGFILE"] = [[A complete restart of WoW is required to use JustBecomePro %s.

%s was not loaded. 

Would you like to restart WoW now?]]
L["ERROR_MISSINGFILE_NOREQ"] = [[A complete restart of WoW may be required to fully use JustBecomePro %s:

%s was not loaded.

Would you like to restart WoW now?]]
L["ERROR_MISSINGFILE_OPT"] = [[A complete restart of WoW is required to configure JustBecomePro %s:

%s was not loaded.

Would you like to restart WoW now?]]
L["ERROR_MISSINGFILE_OPT_NOREQ"] = [[A complete restart of WoW may be required to fully configure JustBecomePro %s:
...
L["ANCHOR_CURSOR_DUMMY"] = "JustBecomePro Cursor Anchor Dummy"
...
L["ERROR_ANCHORSELF"] = "%s was trying to anchor to itself, so JustBecomePro reset it's anchor to the center of the screen to prevent catastrophic failure."
L["ERROR_ANCHOR_CYCLICALDEPS"] = "%s was trying to anchor to %s, but the position of %s depends on the position of %s, so JustBecomePro reset it's anchor to the center of the screen to prevent catastrophic failure."

L["ERROR_NO_LOCKTOGGLE_IN_LOCKDOWN"] = "Cannot unlock JustBecomePro in combat if the %q option isn't enabled (type '/jbp options' to access this option)."
L["ERROR_ACTION_DENIED_IN_LOCKDOWN"] = "Cannot do that in combat if the %q option isn't enabled (type '/jbp options' to access this option)."

L["ERROR_NOTINITIALIZED_NO_LOAD"] = "JustBecomePro_Options cannot be loaded if JustBecomePro failed to initialize!"
L["ERROR_NOTINITIALIZED_NO_ACTION"] = "JustBecomePro cannot perform that action if the addon failed to initialize!"
L["ERROR_NOTINITIALIZED_OPT_NO_ACTION"] = "JustBecomePro_Options cannot perform that action if the addon failed to initialize!"
...
L["FROMNEWERVERSION"] = "You have imported data that was created in a newer version of JustBecomePro than your version. Some settings might not work until you upgrade to the latest version."
...
Icons only work when JustBecomePro is locked, so type '/jbp' when you are finished.


As you configure JustBecomePro, make sure to read the tooltips for each setting. These tooltips contain important information about the how the setting works!]]
...
L["ICONMENU_GROUPUNIT_DESC"] = [[Group is a special unit in JustBecomePro that will track raid members if you are in a raid, or party members if you are in a party.
...
You can also type /justbecomepro or /jbp to lock/unlock.]]
...
L["UIPANEL_GROUPTYPE_ICON_DESC"] = [[Displays the icons in the group using JustBecomePro's traditional icon display.]]
...
L["UIPANEL_COMBATCONFIG_DESC"] = [[Enable this to allow configuration of JustBecomePro while in combat.
...
L["UIPANEL_ENABLEBACKUP_DESC"] = [[When enabled, JustBecomePro will also save your settings in JustBecomePro_Options' settings.

If JustBecomePro's settings become unreadable, which can happen occasionally to any addon settings when WoW doesn't exit properly, it is likely that this second copy of your settings will be just fine. JustBecomePro will automatically restore this copy when this happens.

This process does require that JBP save and load your settings twice, which can cause slightly longer load times. If you already maintain backups on your computer of your WoW addon settings, you can turn this off.]]

L["UIPANEL_ENABLEIMPORTBACKUP"] = "Enable Fresh Import Source"
L["UIPANEL_ENABLEIMPORTBACKUP_DESC"] = [[When enabled, JustBecomePro creates a copy of your settings when JustBecomePro_Options is loaded.
...
This does not impact CPU usage, but will slightly increase memory usage of JustBecomePro_Options and therefore can have a negative impact on older systems with 2GB of RAM or less.]]
...
L["UIPANEL_WARNINVALIDS_DESC"] = [[If this setting is enabled, JustBecomePro when warn you when it detects invalid configurations in your icons.
...
L["TEXTLAYOUTS_USEDBY_NONE"] = "This layout is not used by any of your JustBecomePro profiles."
...
L["TEXTLAYOUTS_NOEDIT_DESC"] = [[This text layout is a default layout that comes standard with JustBecomePro and cannot be modified.
...
As a result, none of the settings below will have any effect when this layout is used on JustBecomePro icons that are skinned by Masque.]]
...
It does NOT work for: |TInterface/AddOns/JustBecomePro/Textures/Alert:0:2|t
...
If more help is needed (but not help about how to write Lua code), try the JBP Discord. For help on how to write Lua, go to the internet.]]
...
To force an exact match of a timer name, enter ^timer name$. This MUST match the timer name as lowercase, as JBP stores the timer names as lowercase.
...
L["CODESNIPPET_AUTORUN_DESC"] = "If enabled, this snippet will be run when JBP_INITIALIZE fires (which happens during PLAYER_LOGIN, but before any icons or groups are created)."

L["CODESNIPPETS"] = "Lua Code Snippets"
L["CODESNIPPETS_TITLE"] = "Lua Snippets"
L["CODESNIPPETS_DESC_SHORT"] = "Write chunks of Lua code that will be ran when JustBecomePro is being initialized."
L["CODESNIPPETS_DESC"] = [[This feature allows you to write chunks of Lua code that will be ran when JustBecomePro is being initialized.

It is an advanced feature for those who have experience with Lua (or for those who have been given a snippet by another JustBecomePro user).
...
To insert a reference to a JustBecomePro icon in your code, |cff7fffffshift-click|r that icon.]]
...
L["TABGROUP_ICON_DESC"] = "Configure JustBecomePro Icons."
L["TABGROUP_GROUP_DESC"] = "Configure JustBecomePro Groups."
L["TABGROUP_MAIN_DESC"] = "Configure general JustBecomePro settings."
...
L["CNDT_UNKNOWN_DESC"] = "Your settings contain a condition with the identifier %s, but no such condition could be found. You may be using an old version of JBP, or this condition may have been removed."
...
L["HELP_ISSUES_DESC"] = [[Report bugs and request features on the official JustBecomePro issue tracker on GitHub.]]
L["HELP_COMMUNITY"] = "Community Discord"
L["HELP_COMMUNITY_DESC"] = [[Join the official JustBecomePro discord!

Ask questions, share configuration, or just hang out with other JustBecomePro users.]]


L["MISCELLANEOUS"] = "Miscellaneous"
L["TEXTMANIP"] = "Text manipulation"
L["DT_DOC_Counter"] = "Returns the value of a JustBecomePro Counter. Counters are created and modified with Icon Notifications."
L["DT_DOC_Timer"] = "Returns the value of a JustBecomePro Timer. Timers are created and modified with Icon Notifications."
L["DT_DOC_JBPFormatDuration"] = "Returns a string formatted by JustBecomePro's time format. Alternative to [FormatDuration]."
...
L["DT_DOC_Duration"] = "Returns the current duration remaining on the icon. It is recommended that you format this with [JBPFormatDuration]"
...
L["MESSAGERECIEVE"] = "%s has sent you some JustBecomePro data! You can import this data into JustBecomePro using the %q button, located at the bottom of the icon editor."
L["MESSAGERECIEVE_SHORT"] = "%s has sent you some JustBecomePro data!"
L["CONFIGPANEL_COMM_HEADER"] = "Communication"
L["ALLOWCOMM"] = "Allow in-game sharing"
L["ALLOWCOMM_DESC"] = [[Allow other JustBecomePro users to send you data.
...
L["NEWVERSION"] = "A new version of JustBecomePro is available: %s"
...
L["IMPORT_FROMSTRING_DESC"] = [[Strings allow you to transfer JustBecomePro configuration data outside the game.
...
L["IMPORT_FROMCOMM_DESC"] = "If another user of JustBecomePro sends you any configuration data, you will be able to import that data from this submenu."
...
L["EXPORT_SPECIALDESC2"] = "Other JustBecomePro users can only import this data if they have version %s"
L["EXPORT_f"] = "Export %s"
...
L["IMPORT_GROUPNOVISIBLE"] = "The group you just imported isn't shown because of its configuration and your current class and specialization. Check its setting in JBP's group options - '/jbp options'."
...
L["CACHING"] = [[JustBecomePro is caching and filtering all spells in the game.

You do not have to wait for this process to complete in order to use JustBecomePro. Only the suggestion list is dependent on the completion of the spell cache.]]
L["CACHINGSPEED"] = "Spells per frame:"
L["SUGGESTIONS"] = "Suggestions:"
L["SUGGESTIONS_SORTING"] = "Sorting..."
L["SUGGESTIONS_DOGTAGS"] = "DogTags:"
L["SUG_TOOLTIPTITLE_GENERIC"] = [[As you type, JustBecomePro will try to determine the input that you were looking for.

This list is not always exhaustive - in some cases, there may be valid input that doesn't appear. You also don't have to use the entries in the suggestion list - as long as you type the correct text into the editbox, JustBecomePro will accept it without issue.

Clicking on an entry will insert it into the editbox.]]
L["SUG_TOOLTIPTITLE"] = [[As you type, JustBecomePro will look through its cache and determine the spells that you were most likely looking for.
...
You can also change the sound channel that JustBecomePro is configured to use in JustBecomePro's main options ('/jbp options')]]
...
Advanced Users: Counters are stored in JBP.COUNTERS[counterName] = value.   Call JBP:Fire( "JBP_COUNTER_MODIFIED", counterName ) if you change a counter in a custom Lua script.]]
...
L["HELP_SCROLLBAR_DROPDOWN"] = [[Some of JustBecomePro's dropdown menus have scrollbars.
...
L["CHANGELOG_INFO2"] = [[Welcome to JustBecomePro v%s!
<br/><br/>
When you're done checking out what has changed, click the %s tab or %s tab at the bottom to start configuring JustBecomePro.]]
...
L["IMPORT_LUA_DESC"] = [[The data you are importing contains the following Lua code that can be executed by JustBecomePro.
...
L["IMPORT_LUA_DESC2"] = "|TInterface/AddOns/JustBecomePro/Textures/Alert:0:2|t Be sure to review the parts of the code in red, which are common words/phrases that could indicate malicious activity. |TInterface/AddOns/JustBecomePro/Textures/Alert:0:2|t"
