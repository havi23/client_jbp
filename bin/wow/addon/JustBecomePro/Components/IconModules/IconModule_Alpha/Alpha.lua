...
local Alpha = JBP:NewClass("IconModule_Alpha", "IconModule")
...
Alpha:RegisterConfigPanel_ConstructorFunc(195, "JustBecomePro_AlphaModuleSettings", function(self)
