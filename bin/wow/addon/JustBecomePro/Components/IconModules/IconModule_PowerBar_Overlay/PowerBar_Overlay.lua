...
local PowerBar_Overlay = JBP:NewClass("IconModule_PowerBar_Overlay", "IconModule_PowerBar")
...
PowerBar_Overlay:RegisterConfigPanel_XMLTemplate(215, "JustBecomePro_PBarOptions")
