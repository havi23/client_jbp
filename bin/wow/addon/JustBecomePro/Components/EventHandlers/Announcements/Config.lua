...
JBP:RegisterCallback("JBP_OPTIONS_LOADED", function(event)
	JBP:ConvertContainerToScrollFrame(Announcements.ConfigContainer.ConfigFrames)

	Announcements.ConfigContainer.SubHandlerListHeader:SetText(JBP.L["ANN_CHANTOUSE"])
...
Announcements:PostHookMethod("LoadSettingsForEventID", function(self, id)
	...
	self.ConfigContainer.EditBox.Error:SetText(JBP:TestDogTagString(CI.icon, EventSettings.Text))
end)
