...
local Lua = JBP.C.EventHandler_WhileConditions_Repetitive:New("Lua", 100)
...
function Lua:ProcessIconEventSettings(event, eventSettings)
	return eventSettings.Lua ~= JBP.Icon_Defaults.Events["**"].Lua and type(self:GetCompiledFunction(eventSettings.Lua)) == "function"
end
