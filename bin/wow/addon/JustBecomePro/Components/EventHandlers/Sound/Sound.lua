...
local Sound = JBP.C.EventHandler_WhileConditions_Repetitive:New("Sound", 10)
...
function Sound:GetSoundFileFromSettingValue(sound)
	...
	sound = JBP:CleanPath(sound)
	local quiet = JBP:CleanPath("Interface/Quiet.ogg")
...
function Sound:PlaySoundFromSettingValue(settingValue)
	...
	if sound then
		if isKit then
		 	PlaySound(sound, JBP.db.profile.SoundChannel)
		else
			PlaySoundFile(sound, JBP.db.profile.SoundChannel)
		end
...
do	-- LSM sound registration
	...
	LSM:Register("sound", "JBP - Pling 1", [[Interface\Addons\JustBecomePro\Sounds\Pling1.ogg]])
	LSM:Register("sound", "JBP - Pling 2", [[Interface\Addons\JustBecomePro\Sounds\Pling2.ogg]])
	LSM:Register("sound", "JBP - Pling 3", [[Interface\Addons\JustBecomePro\Sounds\Pling3.ogg]])
	LSM:Register("sound", "JBP - Pling 4", [[Interface\Addons\JustBecomePro\Sounds\Pling4.ogg]])
	LSM:Register("sound", "JBP - Pling 5", [[Interface\Addons\JustBecomePro\Sounds\Pling5.ogg]])
	LSM:Register("sound", "JBP - Pling 6", [[Interface\Addons\JustBecomePro\Sounds\Pling6.ogg]])
	LSM:Register("sound", "JBP - Ding 1",  [[Interface\Addons\JustBecomePro\Sounds\Ding1.ogg]])
	LSM:Register("sound", "JBP - Ding 2",  [[Interface\Addons\JustBecomePro\Sounds\Ding2.ogg]])
	LSM:Register("sound", "JBP - Ding 3",  [[Interface\Addons\JustBecomePro\Sounds\Ding3.ogg]])
	LSM:Register("sound", "JBP - Ding 4",  [[Interface\Addons\JustBecomePro\Sounds\Ding4.ogg]])
	LSM:Register("sound", "JBP - Ding 5",  [[Interface\Addons\JustBecomePro\Sounds\Ding5.ogg]])
	LSM:Register("sound", "JBP - Ding 6",  [[Interface\Addons\JustBecomePro\Sounds\Ding6.ogg]])
	LSM:Register("sound", "JBP - Ding 7",  [[Interface\Addons\JustBecomePro\Sounds\Ding7.ogg]])
	LSM:Register("sound", "JBP - Ding 8",  [[Interface\Addons\JustBecomePro\Sounds\Ding8.ogg]])
	LSM:Register("sound", "JBP - Ding 9",  [[Interface\Addons\JustBecomePro\Sounds\Ding9.ogg]])
end
