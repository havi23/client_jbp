...
local Type = JBP.Classes.IconType:New("runes")
...
Type:RegisterConfigPanel_XMLTemplate(110, "JustBecomePro_Runes")

Type:RegisterConfigPanel_ConstructorFunc(120, "JustBecomePro_RuneSettings", function(self)
...
Type:RegisterConfigPanel_ConstructorFunc(170, "JustBecomePro_RuneSortSettings", function(self)
