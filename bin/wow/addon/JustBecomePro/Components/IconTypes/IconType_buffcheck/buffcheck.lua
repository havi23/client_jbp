...
local Type = JBP.Classes.IconType:New("buffcheck")
...
local STATE_PRESENT = JBP.CONST.STATE.DEFAULT_HIDE
local STATE_ABSENT = JBP.CONST.STATE.DEFAULT_SHOW
...
Type:RegisterConfigPanel_ConstructorFunc(120, "JustBecomePro_BuffOrDebuff2", function(self)
...
Type:RegisterConfigPanel_ConstructorFunc(125, "JustBecomePro_BuffCheckSettings", function(self)
