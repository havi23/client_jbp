...
local Type = JBP.Classes.IconType:New("item")
...
Type:RegisterConfigPanel_ConstructorFunc(150, "JustBecomePro_ItemSettings", function(self)
...
function Type:Setup(icon)
	icon.Items = JBP:GetItems(icon.Name)
...
function Type:GetConfigIconTexture(icon)
	if icon.Name == "" then
		...
		local tbl = JBP:GetItems(icon.Name)
