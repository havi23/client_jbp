...
local offset = JBP.tContains({"ROGUE", "DRUID"}, pclass) and 0 or 62
...
offset = JBP.tContains({"PALADIN", "PRIEST", "SHAMAN", "MAGE", "WARLOCK", "DRUID", "MONK"}, pclass) and S or 0
...
offset = JBP.tContains({"ROGUE", "DRUID"}, pclass) and S or 0
...
offset = JBP.tContains({"WARRIOR", "DRUID"}, pclass) and S or 0
