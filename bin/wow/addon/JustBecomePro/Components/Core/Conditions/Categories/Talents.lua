...
function SPECS:PrepareUnitSpecEvents()
	...
	SPECS.PrepareUnitSpecEvents = JBP.NULLFUNC
end
ConditionCategory:RegisterCondition(0.1,  "UNITSPEC", {
	...
	events = function(ConditionObject, c)
		...
		return
			...
			ConditionObject:GenerateNormalEventString("JBP_UNITSPEC_UPDATE"),
			ConditionObject:GenerateNormalEventString("PLAYER_TALENT_UPDATE")
	end,
})


JBP:RegisterUpgrade(73019, {
...
ConditionCategory:RegisterCondition(0.3,  "ROLE2", {
	...
	bitFlags = {
		...
		TANK = 		{order = 2, text=TANK, icon = "Interface/AddOns/JustBecomePro/Textures/TANK", },
		HEALER = 	{order = 3, text=HEALER, icon = "Interface/AddOns/JustBecomePro/Textures/HEALER", },
		DAMAGER = 	{order = 4, text=DAMAGER, icon = "Interface/AddOns/JustBecomePro/Textures/DAMAGER", },
	},

	icon = "Interface\\Addons\\JustBecomePro\\Textures\\DAMAGER",
	Env = {
...
ConditionCategory:RegisterCondition(8.1, "TREEROLE2", {
	...
	bitFlagTitle = L["CONDITIONPANEL_BITFLAGS_CHOOSEMENU_TYPES"],
	bitFlags = {
		TANK =    {order = 1, text=TANK, icon = "Interface/AddOns/JustBecomePro/Textures/TANK", },
		HEALER =  {order = 2, text=HEALER, icon = "Interface/AddOns/JustBecomePro/Textures/HEALER", },
		DAMAGER = {order = 3, text=DAMAGER, icon = "Interface/AddOns/JustBecomePro/Textures/DAMAGER", },
	},

	unit = PLAYER,
	icon = "Interface\\Addons\\JustBecomePro\\Textures\\HEALER",
	Env = {
		GetCurrentSpecializationRole = JBP.GetCurrentSpecializationRole,
	},
...
for i, kind in JBP:Vararg("", "_MAJOR") do
