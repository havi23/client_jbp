...
-- to get data about it, and use event JBP_COMMON_SWINGTIMER_CHANGED to listen for swing time starts
...
-- Module creation
JBP.COMMON.SwingTimerMonitor = CreateFrame("Frame")
...
-- Upvalues
local SwingTimers
local SwingTimerMonitor = JBP.COMMON.SwingTimerMonitor
...
local SwingTimer = JBP:NewClass("SwingTimer"){
	...
	CheckTime = function(self)
		local elapsed = JBP.time - self.startTime
	...
	FireChanged = function(self)
		JBP:Fire("JBP_COMMON_SWINGTIMER_CHANGED", self)
	end,
...
{__index = function(self, k)
	...
	-- THIS JBP COMMON MODULE IS INITIALIZED HERE
