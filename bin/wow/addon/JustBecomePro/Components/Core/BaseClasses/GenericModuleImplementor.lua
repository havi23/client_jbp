...
-- @class table
-- @name JBP.Classes.GenericModuleImplementor
...
local GenericModuleImplementor = JBP:NewClass("GenericModuleImplementor", "GenericComponentImplementor")
...
-- @param moduleName [string] Class name of a [[api/base-classes/object-module/|ObjectModule]] to search for. An error is thrown if {{{JBP.Classes[moduleName] == nil}}}.
...
function GenericModuleImplementor:GetModuleOrModuleChild(moduleName, allowDisabled, allowUnimplemented)
	...
	if Module and (allowUnimplemented or self.ComponentsLookup[Module]) and (allowDisabled or Module.IsEnabled) then
		...
		local ModuleClassToSearchFor = JBP.Classes[moduleName]
