...
local IconDataProcessorComponent = JBP:NewClass("IconDataProcessorComponent", "IconComponent")
...
function IconDataProcessorComponent:DeclareUpValue(variables, ...)
	JBP:ValidateType("2 (variables)", "IconDataProcessorComponent:DeclareUpValue(variables, ...)", variables, "string")
