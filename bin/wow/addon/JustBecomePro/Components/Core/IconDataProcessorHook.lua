...
local IconDataProcessorHook = JBP:NewClass("IconDataProcessorHook", "IconDataProcessorComponent")
...
-- @usage
-- local Hook = JBP.Classes.IconDataProcessorHook:New("TEXTURE_CUSTOMTEX", "TEXTURE")
function IconDataProcessorHook:OnNewInstance(name, processorToHook)
	JBP:ValidateType(2, "IconDataProcessorHook:New()", name, "string")
	JBP:ValidateType(3, "IconDataProcessorHook:New()", processorToHook, "string")
	
	local Processor = JBP.Classes.IconDataProcessor.ProcessorsByName[processorToHook]
