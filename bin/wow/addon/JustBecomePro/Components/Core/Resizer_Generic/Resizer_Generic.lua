...
JBP:NewClass("Resizer_Generic"){
	...
	OnNewInstance_Resizer = function(self, parent)
		...
		self.resizeButton = CreateFrame("Button", nil, parent, "JustBecomePro_ResizeButton")
		...
		JBP:TT(self.resizeButton, self.tooltipTitle, self.tooltipText, 1, 1)
	end,

	-- These are here so this class can be inherited with a JBP.C.ObjectModule
