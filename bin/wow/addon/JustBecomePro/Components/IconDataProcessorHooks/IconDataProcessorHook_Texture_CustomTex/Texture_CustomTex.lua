...
Hook:RegisterConfigPanel_XMLTemplate(190, "JustBecomePro_CustomTex")
...
local function UpdateTexture(icon)
	...
	icon.CustomTex_OverrideTex = JBP.COMMON.Textures:EvaluateTexturePath(CustomTex, UpdateTexture, icon)
...
function Hook:OnImplementIntoIcon(icon)
	if icon:IsControlled() and not JBP.Locked then
