...
class PKG(Target):
    """
    Creates a CArchive. CArchive is the data.db structure that is embedded
    into the executable. This data.db structure allows to include various
    read-only data.db in a sigle-file deployment.
    """
    typ = 'PKG'
