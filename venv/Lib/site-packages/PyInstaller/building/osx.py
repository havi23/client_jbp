...
class BUNDLE(Target):
    ...
    def assemble(self):
        ...
        for inm, fnm, typ in toc:
            ...
            # Add most data.db files to a list for symlinking later.
        ...
        logger.info('moving BUNDLE data.db files to Resource directory')

        # Mac OS X Code Signing does not work when .app bundle contains
        # data.db files in dir ./Contents/MacOS.
        #
        # Put all data.db files in ./Resources and create symlinks in ./MacOS.
