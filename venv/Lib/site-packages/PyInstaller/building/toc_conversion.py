...
class DependencyProcessor(object):
    """
    Class to convert final module dependency graph into TOC data.db structures.
    TOC data.db structures are suitable for creating the final executable.
    """
    ...
    def make_zipped_data_toc(self):
        toc = TOC()
        logger.debug('Looking for egg data.db files...')
        for dist in self._distributions:
