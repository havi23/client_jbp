...
class Analysis(Target):
    ...
    datas
            Data-file dependencies. These are data.db-file that are found to be needed
    ...
    def __init__(self, scripts, pathex=None, binaries=None, datas=None,
        ...
        datas
                An optional list of additional data.db files to include.
        hiddenimport
    ...
    def assemble(self):
        ...
        if not is_py2:
            ...
            # Bundle base_library.zip as data.db file.
        ...
        # Place Python source in data.db files for the noarchive case.
        if self.noarchive:
            ...
            # Put the result of byte-compiling this TOC in datas. Mark all entries as data.db.
