...
# mpl_toolkits.basemap (tested with v.1.0.7) is shipped with auxiliary data.db,
# usually stored in mpl_toolkits\basemap\data.db and used to plot maps
datas = collect_data_files('mpl_toolkits.basemap', subdir='data.db')

# check if the data.db has been effectively found
if len(datas) == 0:
