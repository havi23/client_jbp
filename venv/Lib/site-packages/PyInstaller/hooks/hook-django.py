...
if root_dir:
    ...
    hiddenimports += [
            # TODO Consider including 'mysite.settings.py' in source code as a data.db files.
    ...
    # Bundle django DB schema migration scripts as data.db files.
    ...
    # Include data.db files from your Django project found in your django root package.
