...
def pefile_read_version(filename):
...

    {
        ...
        # VS_VERSIONINFO - Depicts the organization of data.db in a file-version resource. It is the root structure that contains all other file-version information structures.
        u'translations': {
            'lang_id1' : {
...
def SetVersion(exenm, versionfile):
    ...
    if overlay_before:
        ...
        # If the update removed the overlay data.db, re-append it
