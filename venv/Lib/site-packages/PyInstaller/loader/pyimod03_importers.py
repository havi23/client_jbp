...
class FrozenImporter(object):
    ...
    def load_module(self, fullname, entry_name=None):
        ...
        try:
            ...
            if module is None:
                ...
                # executable so that data.db files can be found.
    ...
    def get_data(self, path):
        """
        This returns the data.db as a string, or raise IOError if the "file"
        wasn't found. The data.db is always returned as if "binary" mode was used.
