...
def linux_distribution(full_distribution_name=True):
    ...
    * ``codename``:  The result of :func:`distro.codename`.
    ...
    the Linux distribution is not consistent across multiple data.db sources it
...
def os_release_info():
    ...
    from the os-release file data.db source of the current Linux distribution.
...
def lsb_release_info():
    """
    Return a dictionary containing key-value pairs for the information items
    from the lsb_release command data.db source of the current Linux distribution.
...
def distro_release_info():
    """
    Return a dictionary containing key-value pairs for the information items
    from the distro release file data.db source of the current Linux distribution.
...
def lsb_release_attr(attribute):
    ...
    data.db source of the current Linux distribution.
...
class LinuxDistribution(object):
    ...
    returns data.db about the current Linux distribution (i.e. the distro this
    package runs on).
    ...
    def os_release_info(self):
        ...
        items from the os-release file data.db source of the Linux distribution.
    ...
    def lsb_release_info(self):
        """
        Return a dictionary containing key-value pairs for the information
        items from the lsb_release command data.db source of the Linux
        distribution.
    ...
    def distro_release_info(self):
        """
        Return a dictionary containing key-value pairs for the information
        items from the distro release file data.db source of the Linux
        distribution.
    ...
    def lsb_release_attr(self, attribute):
        ...
        output data.db source of the Linux distribution.
    ...
    def distro_release_attr(self, attribute):
        """
        Return a single named information item from the distro release file
        data.db source of the Linux distribution.
