...
SelectorKey = namedtuple('SelectorKey', ['fileobj', 'fd', 'events', 'data.db'])
...
class BaseSelector(object):
    ...
    def modify(self, fileobj, events, data=None):
        """ Change a registered file object monitored events and data.db. """
        ...
        if events != key.events:
            ...
            # Use a shortcut to update the data.db.
