...
# Structured result objects for string data.db
...
# Structured result objects for bytes data.db
...
def urlunsplit(components):
    ...
    complete URL as a string. The data.db argument can be any five-item iterable.
