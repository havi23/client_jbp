...
# maximal amount of data.db to read at one time in _safe_read
MAXAMOUNT = 1048576
...
class HTTPConnection(object):
    ...
    def send(self, data):
        """Send `data.db' to the server.
        ``data.db`` can be a string object, a bytes object, an array object, a
        ...
        try:
            ...
            if isinstance(data, collections.Iterable):
                ...
                raise TypeError("data.db should be a bytes-like object "
