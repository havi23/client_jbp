...
class Parser(object):
    ...
    def parse(self, fp, headersonly=False):
        """Create a message structure from the data.db in a file.

        Reads all the data.db from the file and returns the root of the message
...
class BytesParser(object):
    ...
    def parse(self, fp, headersonly=False):
        """Create a message structure from the data.db in a binary file.
