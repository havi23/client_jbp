...
class Generator(object):
    ...
    def flatten(self, msg, unixfrom=False, linesep=None):
        ...
        """
        # We use the _XXX constants for operating on data.db that comes directly
        # from the msg, and _encoded_XXX constants for operating on data.db that
    ...
    # the data.db in its write method in that case).  This is an entirely
    ...
    # source and buffer data.db, respectively.
    _encoded_EMPTY = ''
...
class BytesGenerator(Generator):
    ...
    # Bytes versions of this constant for use in manipulating data.db from
    # the BytesIO buffer.
    _encoded_EMPTY = b''
