...
TokenList is a recursive data.db structure.  The terminal nodes of the structure
...
def get_invalid_mailbox(value, endchars):
    ...
    returned acts like a Mailbox, but the data.db attributes are None.
...
def get_invalid_parameter(value):
    ...
    returned acts like a Parameter, but the data.db attributes are None.
