...
class MachO(object):
    ...
    #   commands   - a list of (load_command, somecommand, data.db)
    #                data.db is either a str, or a list of segment structures
