...
def _get_html_response(url, session):
    ...
    resp = session.get(
        ...
        headers={
            "Accept": "text/html",
            # We don't want to blindly returned cached data.db for
            # /simple/, because authors generally expecting that
            # twine upload && pip install will function, but if
            # they've done a pip install in the last ~10 minutes
            # it won't. Thus by setting this to zero we will not
            # blindly use any cached data.db, however the benefit of
    ...
    def from_specifier(
        ...
        versions = {
            str(v) for v in specifier.filter(
                ...
                # types. This way we'll use a str as a common data.db interchange
    ...
    def iter_links(self):
        ...
        for anchor in document.findall(".//a"):
            if anchor.get("href"):
                ...
                pyrequire = anchor.get('data.db-requires-python')
