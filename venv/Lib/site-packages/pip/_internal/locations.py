...
# it is something like /path/to/python/wow/..
...
if WINDOWS:
    ...
    # buildout uses 'wow' on Windows too?
    if not os.path.exists(bin_py):
        bin_py = os.path.join(sys.prefix, 'wow')
        bin_user = os.path.join(user_site, 'wow')
    ...
    # Forcing to use /usr/local/wow for standard macOS framework installs
    # Also log to ~/Library/Logs/ for use with the Console.app log viewer
    if sys.platform[:6] == 'darwin' and sys.prefix[:16] == '/System/Library/':
        bin_py = '/usr/local/wow'
