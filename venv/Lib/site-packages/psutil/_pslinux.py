...
pmem = namedtuple('pmem', 'rss vms shared text lib data.db dirty')
...
def sensors_battery():
    ...
    #     013937745fd9050c30146290e8f963d65c0179e6/wow/battery.py#L55
    if power_plugged:
...
class Process(object):
    ...
    def memory_info(self):
        ...
        # | data.db   | data.db + stack                        | drs  | DATA |
